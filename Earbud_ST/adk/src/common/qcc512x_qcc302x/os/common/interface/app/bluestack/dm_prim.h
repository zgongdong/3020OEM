 ...
 *      Appropiate key_type field needs to be set by the caller to indicate the
 ...
 *      Appropiate key_type field needs to be set by the caller to indicate
 ...
 *
 *      Similarly the Public Key with a UINT16 reperesentation:
 *      M(15)---------------------------------------------------L(ed)
...
/*----------------------------------------------------------------------------*
 * PURPOSE
 *      This API allows application to perfrom AES_128 encryption on 128 bit
 ...
 *
 *      The plain text with a UINT16 reperesentation:
 *      M(00)-------------------------------L(ff)
 ...
 *      data[7] = 0x0011;
 *
 *      The encryption key with a UINT16 reperesentation:
 *      M(00)-------------------------------L(0f)
 ...
 *      of data. Appropiate 'operation' value needs to be set in the API to
 ...
 *
 *      The even length application data with a UINT16 reperesentation:
 *      M(61)-------------------------------L(70)
 ...
 *      data_length = 16(0x10)
 *
 *      The odd length application data with a UINT16 reperesentation:
 *       M(61)------------------------------L(6f)
 ...
 *
 *      For ECC-192 a "public_key" (UINT16 reperesentation) generated as following:
 *      M(15)--------------------------------------------------- L(ed)
 *      |1520|7009|9844|21a6|586f|9fc3|fe7e|4329|d280|9ea5|1125|f8ed|<-- Public key X
 *      M(b0)--------------------------------------------------- L(25)
 *      |b09d|42b8|1bc5|bd00|9f79|e4b5|9dbb|aa85|7fca|856f|b9f7|ea25|<-- Public key Y
 ...
 *      M(88)-----------------------------------------------------------------------L(89)
 *      |88d4|266f|d4e6|338d|13b8|45fc|f289|579d|209c|8978|23b9|217d|a3e1|6193|6f03|1589|

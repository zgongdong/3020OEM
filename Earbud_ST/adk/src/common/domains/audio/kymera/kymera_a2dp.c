...
static bool appKymeraA2dpStartMaster(const a2dp_codec_settings *codec_settings, int16 volume_in_db)
{
...
static void appKymeraA2dpStartSlave(a2dp_codec_settings *codec_settings, int16 volume_in_db)
{
    kymeraTaskData *theKymera = KymeraGetTaskData();

...
} device_connect_params_t;

static device_connect_params_t handset_connect_params = { .audio_sink = NULL, .codec = hfp_wbs_codec_mask_msbc, .wesco = 0, .qce_codec_mode_id = 0 };
...
{
    hfp_codec_mode_t codec_mode = (handset_connect_params.codec == hfp_wbs_codec_mask_msbc) ? hfp_codec_mode_wideband : hfp_codec_mode_narrowband;
#ifdef INCLUDE_SWB
...
static bool hfpProfile_GetConnectParameters(voice_source_t source, source_defined_params_t * source_params)
{
    ...
    voice_connect_params->audio_sink = handset_connect_params.audio_sink;
    voice_connect_params->codec_mode = hfpProfile_GetCodecMode();
    voice_connect_params->wesco = handset_connect_params.wesco;
...
{
    handset_connect_params.audio_sink = cfm->audio_sink;
    handset_connect_params.codec = cfm->codec;
    handset_connect_params.wesco = cfm->wesco;
#ifdef INCLUDE_SWB
    handset_connect_params.qce_codec_mode_id = cfm->qce_codec_mode_id;
#endif
}

                                        ...
                                        Message goal_data)
{
    ...
    {
        proc_start_cfm_fn(tws_topology_procedure_disconnect_peer_profiles, proc_result_success);
        TwsTopology_DelayedCompleteCfmCallback(proc_complete_fn, 
                                               tws_topology_procedure_disconnect_peer_profiles,
                                               proc_result_success);
    }
...
void TwsTopology_ProcedureDisconnectPeerProfilesCancel(twstop_proc_cancel_cfm_func_t proc_cancel_cfm_fn)
{
    ...
    TwsTopology_DelayedCancelCfmCallback(proc_cancel_cfm_fn, tws_topology_procedure_disconnect_peer_profiles, proc_result_success);
}

void TwsTopology_ProcedureDisconnectPeerProfilesUpdate(Message goal_data)
{
    /* request disconnect for updated profiles */
    TWSTOP_PRIMARY_GOAL_DISCONNECT_PEER_PROFILES_T* dpp = (TWSTOP_PRIMARY_GOAL_DISCONNECT_PEER_PROFILES_T*)goal_data;
    twsTopology_ProcedureDisconnectPeerProfilesStopProfile(dpp->profiles);
}
...
static void twsTopology_ProcDisconnectPeerProfilesStatus(uint8 profile)
{
    ...
    {
        twsTopology_ProcedureDisconnectPeerProfilesResetProc();
        td->complete_fn(tws_topology_procedure_disconnect_peer_profiles, proc_result_success);
    }
}

                              ...
                              const UNITY_FLAGS_T flags)
{
    ...
    if (UnityIsOneArrayNull(expected, actual, lineNumber, file, msg))
        UNITY_FAIL_AND_BAIL;
                                 ...
                                 const UNITY_FLAGS_T flags)
{
    ...
    if (UnityIsOneArrayNull((UNITY_INTERNAL_PTR)expected, (UNITY_INTERNAL_PTR)actual, lineNumber, file, msg))
    {
        UNITY_FAIL_AND_BAIL;
    }
...
void UnityFail(const char* msg, const UNITY_LINE_TYPE line, const char* file)
{
    (void) file;
    RETURN_IF_FAIL_OR_IGNORE;
...
/*-----------------------------------------------*/
void UnityIgnore(const char* msg, const UNITY_LINE_TYPE line, const char* file)
{
    (void) file;
    RETURN_IF_FAIL_OR_IGNORE;
...
int UnityStringArgumentMatches(const char* str)
{
    ...
    while (ptr1[0] != 0)
    {
        ...
        {
            ptr2++;
            if ((ptr2[0] == ':') && (ptr2[1] != 0) && (ptr2[0] != 39 /* '\'' */) && (ptr2[0] != 34 /* '\"' */) && (ptr2[0] != ','))
                ptrf = &ptr2[1];
        } while ((ptr2[0] != 0) && (ptr2[0] != 39 /* '\'' */) && (ptr2[0] != 34 /* '\"' */) && (ptr2[0] != ','));
        while ((ptr2[0] != 0) && ((ptr2[0] == ':') || (ptr2[0] == 39 /* '\'' */) || (ptr2[0] == 34 /* '\"' */) || (ptr2[0] == ',')))
            ptr2++;

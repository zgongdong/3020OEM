...
class CMockGeneratorPluginCexception
  ...
  def mock_function_declarations(function)
    if (function[:args_string] == "void")
      return "#define #{function[:name]}_ExpectAndThrow(cmock_to_throw) #{function[:name]}_CMockExpectAndThrow(__LINE__, cmock_to_throw)\n" +
             "void #{function[:name]}_CMockExpectAndThrow(UNITY_LINE_TYPE cmock_line, const char* cmock_file, CEXCEPTION_T cmock_to_throw);\n"
    else
      return "#define #{function[:name]}_ExpectAndThrow(#{function[:args_call]}, cmock_to_throw) #{function[:name]}_CMockExpectAndThrow(__LINE__, #{function[:args_call]}, cmock_to_throw)\n" +
             "void #{function[:name]}_CMockExpectAndThrow(UNITY_LINE_TYPE cmock_line, const char* cmock_file, #{function[:args_string]}, CEXCEPTION_T cmock_to_throw);\n"
    end
  end
  ...
  def mock_interfaces(function)
    ...
    [ "void #{function[:name]}_CMockExpectAndThrow(UNITY_LINE_TYPE cmock_line, const char* cmock_file, #{arg_insert}CEXCEPTION_T cmock_to_throw)\n{\n",

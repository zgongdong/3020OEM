...
.CONST 	$base_multi_chan_op.multi_chan_channel_struc_struct.NEXT_ACTIVE_FIELD $base_multi_chan_op.offload_multi_chan_channel_struc_struct.NEXT_ACTIVE_FIELD;
.CONST 	$base_multi_chan_op.multi_chan_channel_struc_struct.SINK_BUFFER_PTR_FIELD $base_multi_chan_op.offload_multi_chan_channel_struc_struct.SINK_BUFFER_PTR_FIELD;
.CONST 	$base_multi_chan_op.multi_chan_channel_struc_struct.SOURCE_BUFFER_PTR_FIELD $base_multi_chan_op.offload_multi_chan_channel_struc_struct.SOURCE_BUFFER_PTR_FIELD;
#endif
...
#if defined(BASE_MULTI_CHAN_OFFLOAD) && defined(CAPABILITY_DOWNLOAD_BUILD)
$_offload_multi_channel_copy_mute:
#else
$_multi_channel_copy_mute:
#endif
   pushm <I0, I4>;
   ...
   // Copy or mute
   r5 = multi_channel_copy_mute.channel_copy;
   r1 = multi_channel_copy_mute.channel_mute;
   NULL = r2;
   if NZ r5 = r1;
...
multi_channel_copy_mute.channel_copy:
   r10 = r4,   r0=M[I0,M1];
...
multi_channel_copy_mute.channel_mute:
   r10 = r4,   r0=M[I0,M1];
   r1 = NULL;
...
// *****************************************************************************
#if defined(BASE_MULTI_CHAN_OFFLOAD) && defined(CAPABILITY_DOWNLOAD_BUILD)
$_offload_multi_channel_advance_buffers:
#else
$_multi_channel_advance_buffers:
#endif
   pushm <M2,M3, L0>;
...
// *****************************************************************************
#if defined(BASE_MULTI_CHAN_OFFLOAD) && defined(CAPABILITY_DOWNLOAD_BUILD)
$_offload_multi_channel_get_channel_count:
#else
$_multi_channel_get_channel_count:
#endif
   push rLink;
   call $base_op.base_op_get_class_ext;

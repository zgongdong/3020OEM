...
#include "secure_basic_passthrough_gen_asm.h"
...
$_secure_basic_passthrough_processing:
    ...
    */
   r2 = r0 + $secure_basic_passthrough_struct.SECURE_BASIC_PASSTHROUGH_OP_DATA_struct.PARAMS_FIELD;
   r4 = M[r0 + $secure_basic_passthrough_struct.SECURE_BASIC_PASSTHROUGH_OP_DATA_struct.GAIN_LINEAR_FIELD];
   ...
   r4 = M[r2 + $M.SECURE_BASIC_PASSTHROUGH.PARAMETERS.OFFSET_GAIN];   // in q6.26
   ...
   r4 = r3;
   M[r0 + $secure_basic_passthrough_struct.SECURE_BASIC_PASSTHROUGH_OP_DATA_struct.GAIN_LINEAR_FIELD] = r4;
secure_basic_pass_thru_init_bypass:
   ...
   I6 = r0 + $secure_basic_passthrough_struct.SECURE_BASIC_PASSTHROUGH_OP_DATA_struct.PEAK_LEVEL_1_FIELD;
...
// structure from C
.set $_secure_mono_audio_loop, secure_mono_gain_copy_loop

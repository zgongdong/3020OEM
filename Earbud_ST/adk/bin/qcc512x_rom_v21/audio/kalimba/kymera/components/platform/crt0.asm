...
.MODULE $M.crt0;
#if defined(CHIP_BASE_HYDRA) || defined(CHIP_NAPIER)
   ...
   call $_dm_initialise;
#endif   /* CHIP_BASE_HYDRA || CHIP_NAPIER */
...
$_dm_initialise:
    ...
    do dm2_bss_free_zero_loop;
        M[I0,4] = r2;
    dm2_bss_free_zero_loop:

#ifdef INSTALL_DUAL_CORE_SUPPORT

    // Zero initialise the shared heap region
    I0 =  $MEM_MAP_DM2_SHARED_HEAP_START;
    r10 = $MEM_MAP_DM2_SHEAP_LENGTH_DWORDS;
    r2 = 0;
    do dm2_shared_zero_loop;
        M[I0,4] = r2;
    ...
    I0 =  $MEM_MAP_DM1_HEAP_START;
    r10 = $MEM_MAP_DM1_FHEAP_LENGTH_DWORDS;
    r2 = 0;
    do dm1_fheap_zero_loop;
        M[I0,4] = r2;
    dm1_fheap_zero_loop:

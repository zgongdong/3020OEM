...
#define FILE_ID_TO_INDEX(id)        ((uint16)(FILE_MGR_INDEX_MASK & id ))
...
#define FILE_MGR_IS_NONAUTO(id)   (((id) & FILE_MGR_BASE_ID) == FILE_MGR_BASE_MASK)
#define FILE_MGR_IS_AUTO(id)      (((id) & FILE_MGR_BASE_ID) == FILE_MGR_BASE_ID)

...
// This is useful to reduce the buffer size used for stdout
// when running unit tests on Kalsim to prevent linker errors.
// The size is expressed in machine words.
#ifndef KALSIM_STDOUT_BUF_SIZE
#define KALSIM_STDOUT_BUF_SIZE 1024
#endif

// This file includes a bunch of routines that dump debug info for use in kalsim
// builds. Not sure whether they're very useful, especially putchar since it
// conflicts with pl_trace.
...
#if defined(CHIP_NAPIER)
   .VAR/DM_SHARED_ZI $_stdout_buf[KALSIM_STDOUT_BUF_SIZE];
#else
   .VAR $_stdout_buf[KALSIM_STDOUT_BUF_SIZE];
#endif

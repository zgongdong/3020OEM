...
.CONST $asf100.ALFA_P_FIELD               ADDR_PER_WORD + $asf100.COH_IMAG_FIELD;
// Preprocessing Input channel pointers
.CONST $asf100.PREP_X0_FIELD              ADDR_PER_WORD + $asf100.ALFA_P_FIELD;
...
.CONST $asf100.wnr.IDX_LB_BASE_FIELD      ADDR_PER_WORD + $asf100.wnr.THRESH_SILENCE_FIELD;
.CONST $asf100.wnr.IDX_LENGTH_FIELD       ADDR_PER_WORD + $asf100.wnr.IDX_LB_BASE_FIELD;
.CONST $asf100.wnr.IDX_MEAN_SCALE_FIELD   ADDR_PER_WORD + $asf100.wnr.IDX_LENGTH_FIELD;
.CONST $asf100.wnr.FRES2_DIV_C_FIELD      ADDR_PER_WORD + $asf100.wnr.IDX_MEAN_SCALE_FIELD;
.CONST $asf100.WNROBJ_END_FIELD           0 + $asf100.wnr.FRES2_DIV_C_FIELD;
...
.CONST $asf100.bf.IDX_LB_BASE_FIELD          ADDR_PER_WORD + $asf100.bf.BF_SCRATCH_ADD_IMAG;
.CONST $asf100.bf.IDX_LENGTH_FIELD           ADDR_PER_WORD + $asf100.bf.IDX_LB_BASE_FIELD;
.CONST $asf100.bf.fRes_over_C_FIELD          ADDR_PER_WORD + $asf100.bf.IDX_LENGTH_FIELD;
.CONST $asf100.bf.BB_BASE_FIELD              ADDR_PER_WORD + $asf100.bf.fRes_over_C_FIELD;
.CONST $asf100.bf.BB_MULTI_FIELD             ADDR_PER_WORD + $asf100.bf.BB_BASE_FIELD;
.CONST $asf100.bf.BB_OFFSET_FIELD            ADDR_PER_WORD + $asf100.bf.BB_MULTI_FIELD;
.CONST $asf100.bf.IDX_BIN_OFFSET_FIELD       ADDR_PER_WORD + $asf100.bf.BB_OFFSET_FIELD;
.CONST $asf100.bf.IDX_NUM_GROUPS_FIELD       ADDR_PER_WORD + $asf100.bf.IDX_BIN_OFFSET_FIELD;
.CONST $asf100.bf.IDX_BINS_PER_GROUP_FIELD   ADDR_PER_WORD + $asf100.bf.IDX_NUM_GROUPS_FIELD;
.CONST $asf100.bf.IDX_BINS_DUPLICATED_FIELD  ADDR_PER_WORD + $asf100.bf.IDX_BINS_PER_GROUP_FIELD;
.CONST $asf100.bf.BF_PROCESS_BINS_FIELD      ADDR_PER_WORD + $asf100.bf.IDX_BINS_DUPLICATED_FIELD;
.CONST $asf100.BF_END_FIELD                  0 + $asf100.bf.BF_PROCESS_BINS_FIELD;

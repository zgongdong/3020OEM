...
//Produce / consume 32 bit data
#ifdef DATAFORMAT_32
   .CONST $aacdec.DATA_WIDTH_PER_WORD                      32;
   .CONST $aacdec.HUFFMAN_MASK                     0x80000000;
#else
   .CONST $aacdec.DATA_WIDTH_PER_WORD                      16;
   .CONST $aacdec.HUFFMAN_MASK                         0x8000;
#endif

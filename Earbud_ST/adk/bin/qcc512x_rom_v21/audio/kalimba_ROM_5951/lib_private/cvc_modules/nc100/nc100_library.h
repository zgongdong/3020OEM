...
.CONST $nc100.SWB_Num_FFT_Freq_Bins  257;
.CONST $nc100.BIN_SKIPPED              1;
.CONST $nc100.NUM_PROC                63;
.CONST $nc100.NUM_TAPS_MAX             4;
...
// @DOC_FIELD_FORMAT Pointer 
.CONST $nc100.LRATIO_PTR_FIELD                      3*ADDR_PER_WORD;

// @DOC_FIELD_TEXT NC SNR_mn Field.
// @DOC_FIELD_FORMAT 
.CONST $nc100.SNR_MN_FIELD                          4*ADDR_PER_WORD;

// @DOC_FIELD_TEXT Pointer to DM1 data block, with size of '$nc100.DM1_DATA_SIZE'
// @DOC_FIELD_FORMAT Pointer
.CONST $nc100.DM1_DATA_FIELD                        5*ADDR_PER_WORD;

// @DOC_FIELD_TEXT Pointer to DM2 data block, with size of '$nc100.DM2_DATA_SIZE'
// @DOC_FIELD_FORMAT Pointer
.CONST $nc100.DM2_DATA_FIELD                        6*ADDR_PER_WORD;

// @DOC_FIELD_TEXT Pointer to DM1 scratch block, with size of '$nc100.DM1_SCRATCH_SIZE'
// @DOC_FIELD_FORMAT Pointer
.CONST $nc100.DM1_SCRATCH_FIELD                     7*ADDR_PER_WORD;

// @DOC_FIELD_TEXT Pointer to NC_ctrl[] buffer, with size of $nc100.NUM_PROC
// @DOC_FIELD_TEXT DM2 allocation is recommended.
// @DOC_FIELD_FORMAT Pointer
.CONST $nc100.NC_CTRL_FIELD                         8*ADDR_PER_WORD;

// @DOC_FIELD_TEXT Pointer to OMS G array
// @DOC_FIELD_FORMAT Pointer
.CONST $nc100.G_OMS_FIELD                          9*ADDR_PER_WORD;

.CONST $nc100.OFFSET_FNLMS_E_FREQ_OBJ              10*ADDR_PER_WORD;
.CONST $nc100.OFFSET_FNLMS_D_FREQ_OBJ              11*ADDR_PER_WORD;
.CONST $nc100.PTR_VARIANT_FIELD                    12*ADDR_PER_WORD;

//
// Internal fields
//
.CONST $nc100.NUM_FFT_FREQ_BIN_FIELD               13*ADDR_PER_WORD;
.CONST $nc100.NTAPS_FIELD                          14*ADDR_PER_WORD;                      
.CONST $nc100.LMUP_FIELD                           15*ADDR_PER_WORD;  
.CONST $nc100.L_ALFAPX_FIELD                       16*ADDR_PER_WORD;
.CONST $nc100.X0_WB2NB_REAL_FIELD                  17*ADDR_PER_WORD;
.CONST $nc100.X0_WB2NB_IMAG_FIELD                  18*ADDR_PER_WORD;
.CONST $nc100.X0_WB2NB_EXP_FIELD                   19*ADDR_PER_WORD;  
.CONST $nc100.X1_WB2NB_REAL_FIELD                  20*ADDR_PER_WORD;
.CONST $nc100.X1_WB2NB_IMAG_FIELD                  21*ADDR_PER_WORD;        
.CONST $nc100.X1_WB2NB_EXP_FIELD                   22*ADDR_PER_WORD;
.CONST $nc100.CONST_ONE_FIELD                      23*ADDR_PER_WORD;
.CONST $nc100.FNLMS_X_REAL_FIELD                   24*ADDR_PER_WORD;
.CONST $nc100.FNLMS_X_IMAG_FIELD                   25*ADDR_PER_WORD;
.CONST $nc100.FNLMS_X_BEXP_FIELD                   26*ADDR_PER_WORD;
.CONST $nc100.FNLMS_XBUF_REAL_FIELD                27*ADDR_PER_WORD;
.CONST $nc100.FNLMS_XBUF_IMAG_FIELD                28*ADDR_PER_WORD;
.CONST $nc100.FNLMS_XBUF_BEXP_FIELD                29*ADDR_PER_WORD;
.CONST $nc100.FNLMS_GP_REAL_FIELD                  30*ADDR_PER_WORD;
.CONST $nc100.FNLMS_GP_IMAG_FIELD                  31*ADDR_PER_WORD;
.CONST $nc100.FNLMS_GP_BEXP_FIELD                  32*ADDR_PER_WORD;

.CONST $nc100.FNLMS_FIELD                          33*ADDR_PER_WORD;

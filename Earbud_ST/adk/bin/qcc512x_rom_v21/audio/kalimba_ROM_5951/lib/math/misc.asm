...
.MODULE $M.math.misc.log_add;
   ...
   .CODESEGMENT MATH_PM;
   // Potential candidate for balancing allocation betweeen two regions
   .DATASEGMENT MATH_BALANCED_DM;
...
//    - r10 - length(X)
//
//    - I0 (output vector) = Y = approx pow2(X) * exp(1-pow2(X))
//                               in Q1.23 (KAL_ARCH3) / Q1.31 (KAL_ARCH4)
//    - I1  (input vector) = X in Q8.16 (KAL_ARCH3) / Q8.24 (KAL_ARCH4)
//
// OUTPUTS:
//    - none
//
...
.MODULE $M.math.misc.exp_int_table;
   ...
   .CODESEGMENT MATH_PM;
   // Potential candidate for balancing allocation between two regions
   .DATASEGMENT MATH_BALANCED_DM;

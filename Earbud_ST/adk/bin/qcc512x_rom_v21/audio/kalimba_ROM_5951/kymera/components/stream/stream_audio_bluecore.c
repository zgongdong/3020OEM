...
DEFINE_ENDPOINT_FUNCTIONS (audio_functions, audio_close, audio_connect,
                           ...
                           stream_audio_kick, audio_sched_kick,
                                    ...
                                    bool *pending)
{
    ...
    if (!endpoint)
    {
        ...
        message[1] = 2;
        message[2] = STREAM_INFO_KEY_AUDIO_SAMPLE_RATE;
        message[3] = STREAM_INFO_KEY_AUDIO_LOCALLY_CLOCKED;
...
static bool audio_buffer_details(ENDPOINT *endpoint, BUFFER_DETAILS *details)
{
    ...
    else
    {
         ...
         */
        details->b.buff_params.size = stream_audio_get_buffer_length(endpoint->state.audio.sample_rate,

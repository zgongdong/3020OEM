...
$_cbuffer_read:
   ...
   if NZ call $error;    // no remote buffers on BC7
#endif

#elif defined(CHIP_BASE_HYDRA) || defined(CHIP_BASE_NAPIER)
   r3 = M[r0 + $cbuffer.DESCRIPTOR_FIELD];
   Null = r3 AND $cbuffer.IS_REMOTE_MMU_MASK;
   if NZ call $error;    // unsupported jump $_cbuffer_read_remote_buff;
#else
...
$_cbuffer_write:
   ...
   r3 = M[r0 + $cbuffer.DESCRIPTOR_FIELD];
   Null = r3 AND $cbuffer.IS_REMOTE_MMU_MASK;
   if NZ call $error;    // unsupported jump $_cbuffer_write_remote_buff;
#else
...
$_cbuffer_copy:
   ...
   r3 = M[r0 + $cbuffer.DESCRIPTOR_FIELD];
   Null = r3 AND $cbuffer.IS_REMOTE_MMU_MASK;
   if NZ call $error;    // unsupported jump $_cbuffer_copy_remote_buff;
   r3 = M[r1 + $cbuffer.DESCRIPTOR_FIELD];
   Null = r3 AND $cbuffer.IS_REMOTE_MMU_MASK;
   if NZ call $error;    // unsupported jump $_cbuffer_copy_remote_buff;
#else

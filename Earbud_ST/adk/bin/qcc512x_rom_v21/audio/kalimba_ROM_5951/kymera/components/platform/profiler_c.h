...
#if defined(PROFILER_ON) && defined(__KCC__)
...
typedef struct profiler
{
    ...
    unsigned total_time;
        ...
        #if defined(CHIP_BASE_CRESCENDO) || defined (CHIP_BASE_NAPIER)
        ...
        #endif /* CHIP_BASE_CRESCENDO || CHIP_BASE_NAPIER */
    #else /* K32 */
...
#else /* defined(PROFILER_ON) && defined(__KCC__) */
...
#endif /* defined(PROFILER_ON) && defined(__KCC__) */

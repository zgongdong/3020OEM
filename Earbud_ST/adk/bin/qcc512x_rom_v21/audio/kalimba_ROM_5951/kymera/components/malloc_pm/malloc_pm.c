...
/**
 * NAME
 *   malloc_pm_reconfigure
 *
 * \brief Reconfigure the PM heap to include unused memory when aux processor is
 * disabled
 *
 */
void malloc_pm_reconfigure(void)
{
    reconfigure_heap_pm();
}
#endif

 ...
 *
 */
extern void stream_anc_set_anc_iir_coeffs(STREAM_ANC_INSTANCE instance,
 ...
 */
extern void stream_anc_enable_wrapper(unsigned con_id,
                                      uint16 anc_enable_0,
                                      uint16 anc_enable_1,
 ...
 *
 */
extern void stream_anc_set_anc_lpf_coeffs(STREAM_ANC_INSTANCE anc_instance,
                                          STREAM_ANC_PATH path_id,
                                          uint16 shift1,
                                          uint16 shift2);

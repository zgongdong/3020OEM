...
typedef enum
{
    ...
    AMSGID_PS_ENTRY_READ        = 0x00001,
    AMSGID_PS_ENTRY_WRITE       = 0x00002,
    AMSGID_PS_ENTRY_DELETE      = 0x00003,
    AMSGID_PS_SHUTDOWN_COMPLETE = 0x00004,
    AMSGID_UNACHIEVABLE_LATENCY = 0x00005,
...
typedef struct
{
    unsigned ep_id;
    unsigned data;
} ADAPTOR_UNACHIEVABLE_LATENCY_MSG;
#define ADAPTOR_UNACHIEVABLE_LATENCY_MSG_WORD_SIZE (2)
...
typedef union
{
    ...
    ADAPTOR_PS_ENTRY_READ_MSG          *adaptor01;
    ADAPTOR_PS_ENTRY_WRITE_MSG         *adaptor02;
    ADAPTOR_PS_ENTRY_DELETE_MSG        *adaptor03;
    ADAPTOR_UNACHIEVABLE_LATENCY_MSG   *adaptor04;
 ...
 */
extern bool adaptor_send_message(unsigned conn_id, ADAPTOR_MSGID msg_id,

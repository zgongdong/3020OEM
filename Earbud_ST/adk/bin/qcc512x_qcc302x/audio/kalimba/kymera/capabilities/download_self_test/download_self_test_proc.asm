...
//
// DESCRIPTION:
//    Tests calling into Insert32 instruction Minim code section from a Maxim one
//
// INPUTS:
//    None
//
...
//
// *****************************************************************************
.MODULE $M.download_self_test_call_from_maxim_to_insert32_instr_test_maxim;
.CODESEGMENT PM;
.DATASEGMENT DM;
.MAXIM;
...
//
// DESCRIPTION:
//    Tests calling into Insert32 instruction Minim code section from a Minim one
//
// INPUTS:
//    None
//
...
//
// *****************************************************************************
.MODULE $M.download_self_test_call_from_minim_to_insert32_instr_test_minim;
.CODESEGMENT PM;
.DATASEGMENT DM;
.MINIM;

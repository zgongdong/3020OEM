...
.CONST $dmss.rnr.swb.STATE_SIZE           3 * 35;
...
.CONST $dmss.tp.DIM.HD                    14;
.CONST $dmss.tp.STATE_DM1_SIZE.HD         4 * 2 * $dmss.tp.DIM.HD;
.CONST $dmss.tp.STATE_DM2_SIZE.HD         4 * 2 * $dmss.tp.DIM.HD;

// TP    :  21*2
// RNR   :  65/129/257
// TR    :  130 nb/wb
.CONST $dmss.SCRATCH_DM1_SIZE             257;
...
.CONST $dmss100.NUM_NB_BINS_UWB_FB_MODE   53;
...
.CONST $dmss.rnr.ALFA_P_FIELD            ADDR_PER_WORD + $dmss.rnr.ALFAG_FIELD;
.CONST $dmss.rnr.G_MN_FIELD              ADDR_PER_WORD + $dmss.rnr.ALFA_P_FIELD;
...
.CONST $dmss.tp.BIN_SKIPPED_FIELD        ADDR_PER_WORD + $dmss.tp.DMSC_FIELD;
.CONST $dmss.tp.DIM_FIELD                ADDR_PER_WORD + $dmss.tp.BIN_SKIPPED_FIELD;
.CONST $dmss.tp.ALFA_P_FIELD             ADDR_PER_WORD + $dmss.tp.DIM_FIELD;
.CONST $dmss.tp.MODE_COUNT_MAX_FIELD     ADDR_PER_WORD + $dmss.tp.ALFA_P_FIELD;
.CONST $dmss.tp.MODE_COUNT_FIELD         ADDR_PER_WORD + $dmss.tp.MODE_COUNT_MAX_FIELD;
...
.CONST $dmss.tr.MAP_BIN_OFFSET_FIELD     ADDR_PER_WORD + $dmss.tr.X_OUTPUT_FREQ_OBJ;
.CONST $dmss.tr.MAP_NUM_GROUPS_FIELD     ADDR_PER_WORD + $dmss.tr.MAP_BIN_OFFSET_FIELD;
.CONST $dmss.tr.MAP_BINS_PER_GROUP_FIELD ADDR_PER_WORD + $dmss.tr.MAP_NUM_GROUPS_FIELD;
.CONST $dmss.tr.MAP_AVERAGE_COEF_FIELD   ADDR_PER_WORD + $dmss.tr.MAP_BINS_PER_GROUP_FIELD;
.CONST $dmss.tr.COPY_NUM_G_BINS_FIELD    ADDR_PER_WORD + $dmss.tr.MAP_AVERAGE_COEF_FIELD;

.CONST $dmss.STRUC_SIZE     ($dmss.tr.COPY_NUM_G_BINS_FIELD >> LOG2_ADDR_PER_WORD) + 1;

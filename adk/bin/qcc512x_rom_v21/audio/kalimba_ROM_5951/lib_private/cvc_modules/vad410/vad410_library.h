...
// @DOC_FIELD_FORMAT Q12.12 arch3 | Q12.20 arch4
.CONST   $M.vad410.E_FILTER_FIELD               4*ADDR_PER_WORD;
// @DOC_FIELD_TEXT Maximum of estimate of the amplitude of the signal
// @DOC_FIELD_FORMAT Q12.12 arch3 | Q12.20 arch4
.CONST   $M.vad410.E_FILTER_MAX_FIELD           5*ADDR_PER_WORD;
// @DOC_FIELD_TEXT Minimum of estimate of the amplitude of the signal
// @DOC_FIELD_FORMAT Q12.12 arch3 | Q12.20 arch4
.CONST   $M.vad410.E_FILTER_MIN_FIELD           6*ADDR_PER_WORD;
// @DOC_FIELD_TEXT Internal counter
// @DOC_FIELD_FORMAT Integer
.CONST   $M.vad410.COUNTER_DELTA_FIELD          7*ADDR_PER_WORD;
// @DOC_FIELD_TEXT Counter used by "initialization time".
// @DOC_FIELD_FORMAT Integer
.CONST   $M.vad410.COUNTER_FIELD                8*ADDR_PER_WORD;
// @DOC_FIELD_TEXT Flag identifying that voice has been detected
// @DOC_FIELD_FORMAT Integer
.CONST   $M.vad410.FLAG_FIELD                   9*ADDR_PER_WORD;
// @DOC_FIELD_TEXT Ponter to VAD Flag
// @DOC_FIELD_FORMAT Pointer
.CONST   $M.vad410.PTR_FLAG_FIELD               10*ADDR_PER_WORD;
// @DOC_FIELD_TEXT Bypass Flag
// @DOC_FIELD_FORMAT Bool
.CONST   $M.vad410.BYPASS_VAD                   11*ADDR_PER_WORD;

//
// paramters
//
.CONST   $M.vad410.ATTACK_TC_FIELD              12*ADDR_PER_WORD;
.CONST   $M.vad410.DECAY_TC_FIELD               13*ADDR_PER_WORD;
.CONST   $M.vad410.ENVELOPE_TC_FIELD            14*ADDR_PER_WORD;
.CONST   $M.vad410.INIT_FRAME_THRESH_FIELD      15*ADDR_PER_WORD;
.CONST   $M.vad410.COUNT_THRESHOLD_FIELD        16*ADDR_PER_WORD;
// @DOC_FIELD_TEXT Size of the VAD object
// @DOC_FIELD_FORMAT Integer
.CONST   $M.vad410.OBJECT_SIZE_FIELD            17;

// @END  DATA_OBJECT VAD_DATAOBJECT


.CONST   $M.vad410.DCB_PEQ_COEFF_OFFSET         0*ADDR_PER_WORD;
.CONST   $M.vad410.VAD_SIGAL_OFFSET             9*ADDR_PER_WORD;
.CONST   $M.vad410.VAD_PEQ_COEFF_OFFSET         10*ADDR_PER_WORD;

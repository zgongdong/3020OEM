...
.CONST $dms200.PBP_MODE_FIELD                ADDR_PER_WORD + $dms200.DMS_dim;
.CONST $M.oms280.ALFA_NZ_FIELD               ADDR_PER_WORD + $dms200.PBP_MODE_FIELD;
...
// -----------------------------------------------------------------------------
.CONST $M.oms280.FUNC_MMS_LPXS_FIELD         ADDR_PER_WORD + $M.oms280.VAD_noise_Th;
.CONST $M.oms280.FUNC_MMS_PROC_FIELD         ADDR_PER_WORD + $M.oms280.FUNC_MMS_LPXS_FIELD;
.CONST $M.oms280.PTR_HARM_VALUE_FIELD        ADDR_PER_WORD + $M.oms280.FUNC_MMS_PROC_FIELD;
...
.CONST $dms200.dms.D1_FIELD                     0;

// Pointer to external DMS mode
.CONST $dms200.dms.PTR_MIC_MODE_FIELD           MK1 * 1;

// Pointer to parameter of DOA0
.CONST $dms200.dms.PTR_DOA0_FIELD               MK1 * 2;

// Pointer to parameter of Power Adjustment
// In log2 dB in Q8.16 format
.CONST $dms200.dms.PTR_POWR_ADJUST_FIELD        MK1 * 3;

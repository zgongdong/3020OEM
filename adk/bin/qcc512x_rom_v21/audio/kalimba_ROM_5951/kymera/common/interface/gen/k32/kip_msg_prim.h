...
#define KIP_MSG_ID_TO_ADAPTOR_MSGID(msg_id)                             ((ADAPTOR_MSGID)(msg_id + AMSGID_KIP_START))
...
/*******************************************************************************
 ...
 VALUES
    ...
    FILE_MGR_RELEASE_FILE_REQ         -
    STREAM_CONNECT_CONFIRM_REQ        -
    CREATE_OPERATOR_RES               -
...
typedef enum
{
    ...
    KIP_MSG_ID_FILE_MGR_RELEASE_FILE_REQ = 0x101A,
    KIP_MSG_ID_STREAM_CONNECT_CONFIRM_REQ = 0x101B,
    ...
    KIP_MSG_ID_FILE_MGR_RELEASE_FILE_RES = 0x501A
} KIP_MSG_ID;
...
/*******************************************************************************
  ...
  NAME
    KIP_MSG_FILE_MGR_RELEASE_FILE_REQ
  ...
  MEMBERS
    ...
    file_id - An array of key-value objects
...
/* The following macros take KIP_MSG_FILE_MGR_RELEASE_FILE_REQ *kip_msg_file_mgr_release_file_req_ptr */
#define KIP_MSG_FILE_MGR_RELEASE_FILE_REQ_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_FILE_MGR_RELEASE_FILE_REQ_CON_ID_GET(kip_msg_file_mgr_release_file_req_ptr) ((kip_msg_file_mgr_release_file_req_ptr)->_data[0])
#define KIP_MSG_FILE_MGR_RELEASE_FILE_REQ_CON_ID_SET(kip_msg_file_mgr_release_file_req_ptr, con_id) ((kip_msg_file_mgr_release_file_req_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_FILE_MGR_RELEASE_FILE_REQ_FILE_ID_WORD_OFFSET (1)
#define KIP_MSG_FILE_MGR_RELEASE_FILE_REQ_FILE_ID_GET(kip_msg_file_mgr_release_file_req_ptr) ((kip_msg_file_mgr_release_file_req_ptr)->_data[1])
#define KIP_MSG_FILE_MGR_RELEASE_FILE_REQ_FILE_ID_SET(kip_msg_file_mgr_release_file_req_ptr, file_id) ((kip_msg_file_mgr_release_file_req_ptr)->_data[1] = (uint16)(file_id))
#define KIP_MSG_FILE_MGR_RELEASE_FILE_REQ_WORD_SIZE (2)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_FILE_MGR_RELEASE_FILE_REQ_CREATE(con_id, file_id) \
    (uint16)(con_id), \
    (uint16)(file_id)
#define KIP_MSG_FILE_MGR_RELEASE_FILE_REQ_PACK(kip_msg_file_mgr_release_file_req_ptr, con_id, file_id) \
    do { \
        (kip_msg_file_mgr_release_file_req_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_file_mgr_release_file_req_ptr)->_data[1] = (uint16)((uint16)(file_id)); \
    } while (0)
...
/*******************************************************************************
  ...
  NAME
    KIP_MSG_FILE_MGR_RELEASE_FILE_RES
  ...
  MEMBERS
    ...
    con_id  - Connection id with sender/receiver processor and SW client IDs as
              per common adaptor definition
    file_id - The number of key-value pairs in the message.
...
/* The following macros take KIP_MSG_FILE_MGR_RELEASE_FILE_RES *kip_msg_file_mgr_release_file_res_ptr */
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_STATUS_WORD_OFFSET (0)
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_STATUS_GET(kip_msg_file_mgr_release_file_res_ptr) ((kip_msg_file_mgr_release_file_res_ptr)->_data[0])
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_STATUS_SET(kip_msg_file_mgr_release_file_res_ptr, status) ((kip_msg_file_mgr_release_file_res_ptr)->_data[0] = (uint16)(status))
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_CON_ID_WORD_OFFSET (1)
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_CON_ID_GET(kip_msg_file_mgr_release_file_res_ptr) ((kip_msg_file_mgr_release_file_res_ptr)->_data[1])
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_CON_ID_SET(kip_msg_file_mgr_release_file_res_ptr, con_id) ((kip_msg_file_mgr_release_file_res_ptr)->_data[1] = (uint16)(con_id))
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_FILE_ID_WORD_OFFSET (2)
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_FILE_ID_GET(kip_msg_file_mgr_release_file_res_ptr) ((kip_msg_file_mgr_release_file_res_ptr)->_data[2])
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_FILE_ID_SET(kip_msg_file_mgr_release_file_res_ptr, file_id) ((kip_msg_file_mgr_release_file_res_ptr)->_data[2] = (uint16)(file_id))
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_WORD_SIZE (3)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_CREATE(status, con_id, file_id) \
    (uint16)(status), \
    (uint16)(con_id), \
    (uint16)(file_id)
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_PACK(kip_msg_file_mgr_release_file_res_ptr, status, con_id, file_id) \
    do { \
        (kip_msg_file_mgr_release_file_res_ptr)->_data[0] = (uint16)((uint16)(status)); \
        (kip_msg_file_mgr_release_file_res_ptr)->_data[1] = (uint16)((uint16)(con_id)); \
        (kip_msg_file_mgr_release_file_res_ptr)->_data[2] = (uint16)((uint16)(file_id)); \
    } while (0)
...
/*******************************************************************************
  ...
  MEMBERS
    con_id    - connection id with sender/receiver processor and SW client IDs
                as per common adaptor definition
    ext_op_id - The external ID of the operator that sent the message
    client_id - The client ID that created the operator
    msg_id    - The type of message sent by the operator
...
#define KIP_MSG_MESSAGE_FROM_OPERATOR_REQ_EXT_OP_ID_WORD_OFFSET (1)
#define KIP_MSG_MESSAGE_FROM_OPERATOR_REQ_EXT_OP_ID_GET(kip_msg_message_from_operator_req_ptr) ((kip_msg_message_from_operator_req_ptr)->_data[1])
#define KIP_MSG_MESSAGE_FROM_OPERATOR_REQ_EXT_OP_ID_SET(kip_msg_message_from_operator_req_ptr, ext_op_id) ((kip_msg_message_from_operator_req_ptr)->_data[1] = (uint16)(ext_op_id))
#define KIP_MSG_MESSAGE_FROM_OPERATOR_REQ_CLIENT_ID_WORD_OFFSET (2)
#define KIP_MSG_MESSAGE_FROM_OPERATOR_REQ_CLIENT_ID_GET(kip_msg_message_from_operator_req_ptr) ((kip_msg_message_from_operator_req_ptr)->_data[2])
#define KIP_MSG_MESSAGE_FROM_OPERATOR_REQ_CLIENT_ID_SET(kip_msg_message_from_operator_req_ptr, client_id) ((kip_msg_message_from_operator_req_ptr)->_data[2] = (uint16)(client_id))
#define KIP_MSG_MESSAGE_FROM_OPERATOR_REQ_MSG_ID_WORD_OFFSET (3)
#define KIP_MSG_MESSAGE_FROM_OPERATOR_REQ_MSG_ID_GET(kip_msg_message_from_operator_req_ptr) ((kip_msg_message_from_operator_req_ptr)->_data[3])
#define KIP_MSG_MESSAGE_FROM_OPERATOR_REQ_MSG_ID_SET(kip_msg_message_from_operator_req_ptr, msg_id) ((kip_msg_message_from_operator_req_ptr)->_data[3] = (uint16)(msg_id))
#define KIP_MSG_MESSAGE_FROM_OPERATOR_REQ_LENGTH_WORD_OFFSET (4)
#define KIP_MSG_MESSAGE_FROM_OPERATOR_REQ_LENGTH_GET(kip_msg_message_from_operator_req_ptr) ((kip_msg_message_from_operator_req_ptr)->_data[4])
#define KIP_MSG_MESSAGE_FROM_OPERATOR_REQ_LENGTH_SET(kip_msg_message_from_operator_req_ptr, length) ((kip_msg_message_from_operator_req_ptr)->_data[4] = (uint16)(length))
#define KIP_MSG_MESSAGE_FROM_OPERATOR_REQ_MESSAGE_WORD_OFFSET (5)
#define KIP_MSG_MESSAGE_FROM_OPERATOR_REQ_MESSAGE_GET(kip_msg_message_from_operator_req_ptr) ((kip_msg_message_from_operator_req_ptr)->_data[5])
#define KIP_MSG_MESSAGE_FROM_OPERATOR_REQ_MESSAGE_SET(kip_msg_message_from_operator_req_ptr, message) ((kip_msg_message_from_operator_req_ptr)->_data[5] = (uint16)(message))
#define KIP_MSG_MESSAGE_FROM_OPERATOR_REQ_WORD_SIZE (6)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_MESSAGE_FROM_OPERATOR_REQ_CREATE(con_id, ext_op_id, client_id, msg_id, length, message) \
    (uint16)(con_id), \
    (uint16)(ext_op_id), \
    (uint16)(client_id), \
    (uint16)(msg_id), \
    (uint16)(length), \
    (uint16)(message)
#define KIP_MSG_MESSAGE_FROM_OPERATOR_REQ_PACK(kip_msg_message_from_operator_req_ptr, con_id, ext_op_id, client_id, msg_id, length, message) \
    do { \
        (kip_msg_message_from_operator_req_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_message_from_operator_req_ptr)->_data[1] = (uint16)((uint16)(ext_op_id)); \
        (kip_msg_message_from_operator_req_ptr)->_data[2] = (uint16)((uint16)(client_id)); \
        (kip_msg_message_from_operator_req_ptr)->_data[3] = (uint16)((uint16)(msg_id)); \
        (kip_msg_message_from_operator_req_ptr)->_data[4] = (uint16)((uint16)(length)); \
        (kip_msg_message_from_operator_req_ptr)->_data[5] = (uint16)((uint16)(message)); \
    } while (0)
...
#define KIP_MSG_PS_READ_RES_TOTAL_LEN_WORD_OFFSET (2)
#define KIP_MSG_PS_READ_RES_TOTAL_LEN_GET(kip_msg_ps_read_res_ptr) ((kip_msg_ps_read_res_ptr)->_data[2])
#define KIP_MSG_PS_READ_RES_TOTAL_LEN_SET(kip_msg_ps_read_res_ptr, total_len) ((kip_msg_ps_read_res_ptr)->_data[2] = (uint16)(total_len))
#define KIP_MSG_PS_READ_RES_DATA_WORD_OFFSET (3)
#define KIP_MSG_PS_READ_RES_DATA_GET(kip_msg_ps_read_res_ptr) ((kip_msg_ps_read_res_ptr)->_data[3])
#define KIP_MSG_PS_READ_RES_DATA_SET(kip_msg_ps_read_res_ptr, data) ((kip_msg_ps_read_res_ptr)->_data[3] = (uint16)(data))
#define KIP_MSG_PS_READ_RES_WORD_SIZE (4)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_PS_READ_RES_CREATE(status, con_id, Total_Len, data) \
    (uint16)(status), \
    (uint16)(con_id), \
    (uint16)(Total_Len), \
    (uint16)(data)
#define KIP_MSG_PS_READ_RES_PACK(kip_msg_ps_read_res_ptr, status, con_id, Total_Len, data) \
    do { \
        (kip_msg_ps_read_res_ptr)->_data[0] = (uint16)((uint16)(status)); \
        (kip_msg_ps_read_res_ptr)->_data[1] = (uint16)((uint16)(con_id)); \
        (kip_msg_ps_read_res_ptr)->_data[2] = (uint16)((uint16)(Total_Len)); \
        (kip_msg_ps_read_res_ptr)->_data[3] = (uint16)((uint16)(data)); \
    } while (0)
...
#define KIP_MSG_PS_WRITE_RES_WORD_SIZE (2)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_PS_WRITE_RES_CREATE(status, con_id) \
    (uint16)(status), \
    (uint16)(con_id)
#define KIP_MSG_PS_WRITE_RES_PACK(kip_msg_ps_write_res_ptr, status, con_id) \
    do { \
...
/*******************************************************************************
  ...
  NAME
    KIP_MSG_STREAM_CONNECT_CONFIRM_REQ

  DESCRIPTION
    Handle stream_connect confirmation requests from main processor.

  MEMBERS
    con_id  - connection id with sender/receiver processor and SW client IDs as
              per common adaptor definition
    conn_to - The main core operator terminal id that the shadow endpoint is
              connected to.
...
/* The following macros take KIP_MSG_STREAM_CONNECT_CONFIRM_REQ *kip_msg_stream_connect_confirm_req_ptr */
#define KIP_MSG_STREAM_CONNECT_CONFIRM_REQ_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_STREAM_CONNECT_CONFIRM_REQ_CON_ID_GET(kip_msg_stream_connect_confirm_req_ptr) ((kip_msg_stream_connect_confirm_req_ptr)->_data[0])
#define KIP_MSG_STREAM_CONNECT_CONFIRM_REQ_CON_ID_SET(kip_msg_stream_connect_confirm_req_ptr, con_id) ((kip_msg_stream_connect_confirm_req_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_STREAM_CONNECT_CONFIRM_REQ_CONN_TO_WORD_OFFSET (1)
#define KIP_MSG_STREAM_CONNECT_CONFIRM_REQ_CONN_TO_GET(kip_msg_stream_connect_confirm_req_ptr) ((kip_msg_stream_connect_confirm_req_ptr)->_data[1])
#define KIP_MSG_STREAM_CONNECT_CONFIRM_REQ_CONN_TO_SET(kip_msg_stream_connect_confirm_req_ptr, conn_to) ((kip_msg_stream_connect_confirm_req_ptr)->_data[1] = (uint16)(conn_to))
#define KIP_MSG_STREAM_CONNECT_CONFIRM_REQ_WORD_SIZE (2)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_STREAM_CONNECT_CONFIRM_REQ_CREATE(con_id, conn_to) \
    (uint16)(con_id), \
    (uint16)(conn_to)
#define KIP_MSG_STREAM_CONNECT_CONFIRM_REQ_PACK(kip_msg_stream_connect_confirm_req_ptr, con_id, conn_to) \
    do { \
        (kip_msg_stream_connect_confirm_req_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_stream_connect_confirm_req_ptr)->_data[1] = (uint16)((uint16)(conn_to)); \
    } while (0)
...
/*******************************************************************************
  ...
  MEMBERS
    ...
    tinfo_block_size - shadowed operator's block size
    tinfo_period     - shadowed operator's period
...
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_TINFO_BLOCK_SIZE_WORD_OFFSET (5)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_TINFO_BLOCK_SIZE_GET(kip_msg_stream_create_endpoints_req_ptr)  \
    (((uint32)((kip_msg_stream_create_endpoints_req_ptr)->_data[5]) | \
      ((uint32)((kip_msg_stream_create_endpoints_req_ptr)->_data[6]) << 16)))
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_TINFO_BLOCK_SIZE_SET(kip_msg_stream_create_endpoints_req_ptr, tinfo_block_size) do { \
        (kip_msg_stream_create_endpoints_req_ptr)->_data[5] = (uint16)((tinfo_block_size) & 0xffff); \
        (kip_msg_stream_create_endpoints_req_ptr)->_data[6] = (uint16)((tinfo_block_size) >> 16); } while (0)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_TINFO_PERIOD_WORD_OFFSET (7)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_TINFO_PERIOD_GET(kip_msg_stream_create_endpoints_req_ptr)  \
    (((uint32)((kip_msg_stream_create_endpoints_req_ptr)->_data[7]) | \
      ((uint32)((kip_msg_stream_create_endpoints_req_ptr)->_data[7 + 1]) << 16)))
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_TINFO_PERIOD_SET(kip_msg_stream_create_endpoints_req_ptr, tinfo_period) do { \
        (kip_msg_stream_create_endpoints_req_ptr)->_data[7] = (uint16)((tinfo_period) & 0xffff); \
        (kip_msg_stream_create_endpoints_req_ptr)->_data[7 + 1] = (uint16)((tinfo_period) >> 16); } while (0)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_FLAGS_WORD_OFFSET (9)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_FLAGS_GET(kip_msg_stream_create_endpoints_req_ptr) ((kip_msg_stream_create_endpoints_req_ptr)->_data[9])
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_FLAGS_SET(kip_msg_stream_create_endpoints_req_ptr, flags) ((kip_msg_stream_create_endpoints_req_ptr)->_data[9] = (uint16)(flags))
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_WORD_SIZE (10)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_CREATE(con_id, Source_ID, Sink_ID, Channel_ID, Buffer_size, tinfo_block_size, tinfo_period, flags) \
    (uint16)(con_id), \
    (uint16)(Source_ID), \
    (uint16)(Sink_ID), \
    (uint16)(Channel_ID), \
    (uint16)(Buffer_size), \
    (uint16)((tinfo_block_size) & 0xffff), \
    (uint16)((tinfo_block_size) >> 16), \
    (uint16)((tinfo_period) & 0xffff), \
    (uint16)((tinfo_period) >> 16), \
    (uint16)(flags)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_PACK(kip_msg_stream_create_endpoints_req_ptr, con_id, Source_ID, Sink_ID, Channel_ID, Buffer_size, tinfo_block_size, tinfo_period, flags) \
    do { \
        ...
        (kip_msg_stream_create_endpoints_req_ptr)->_data[5] = (uint16)((uint16)((tinfo_block_size) & 0xffff)); \
        (kip_msg_stream_create_endpoints_req_ptr)->_data[6] = (uint16)(((tinfo_block_size) >> 16)); \
        (kip_msg_stream_create_endpoints_req_ptr)->_data[7] = (uint16)((uint16)((tinfo_period) & 0xffff)); \
        (kip_msg_stream_create_endpoints_req_ptr)->_data[7 + 1] = (uint16)(((tinfo_period) >> 16)); \
        (kip_msg_stream_create_endpoints_req_ptr)->_data[9] = (uint16)((uint16)(flags)); \
    } while (0)
...
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_TINFO_BLOCK_SIZE_WORD_OFFSET (4)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_TINFO_BLOCK_SIZE_GET(kip_msg_stream_create_endpoints_res_ptr)  \
    (((uint32)((kip_msg_stream_create_endpoints_res_ptr)->_data[4]) | \
      ((uint32)((kip_msg_stream_create_endpoints_res_ptr)->_data[5]) << 16)))
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_TINFO_BLOCK_SIZE_SET(kip_msg_stream_create_endpoints_res_ptr, tinfo_block_size) do { \
        (kip_msg_stream_create_endpoints_res_ptr)->_data[4] = (uint16)((tinfo_block_size) & 0xffff); \
        (kip_msg_stream_create_endpoints_res_ptr)->_data[5] = (uint16)((tinfo_block_size) >> 16); } while (0)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_TINFO_PERIOD_WORD_OFFSET (6)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_TINFO_PERIOD_GET(kip_msg_stream_create_endpoints_res_ptr)  \
    (((uint32)((kip_msg_stream_create_endpoints_res_ptr)->_data[6]) | \
      ((uint32)((kip_msg_stream_create_endpoints_res_ptr)->_data[7]) << 16)))
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_TINFO_PERIOD_SET(kip_msg_stream_create_endpoints_res_ptr, tinfo_period) do { \
        (kip_msg_stream_create_endpoints_res_ptr)->_data[6] = (uint16)((tinfo_period) & 0xffff); \
        (kip_msg_stream_create_endpoints_res_ptr)->_data[7] = (uint16)((tinfo_period) >> 16); } while (0)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_FLAGS_WORD_OFFSET (8)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_FLAGS_GET(kip_msg_stream_create_endpoints_res_ptr) ((kip_msg_stream_create_endpoints_res_ptr)->_data[8])
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_FLAGS_SET(kip_msg_stream_create_endpoints_res_ptr, flags) ((kip_msg_stream_create_endpoints_res_ptr)->_data[8] = (uint16)(flags))
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_WORD_SIZE (9)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_CREATE(status, con_id, Channel_ID, Buffer_size, tinfo_block_size, tinfo_period, flags) \
    (uint16)(status), \
    (uint16)(con_id), \
    (uint16)(Channel_ID), \
    (uint16)(Buffer_size), \
    ...
    (uint16)((tinfo_period) >> 16), \
    (uint16)(flags)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_PACK(kip_msg_stream_create_endpoints_res_ptr, status, con_id, Channel_ID, Buffer_size, tinfo_block_size, tinfo_period, flags) \
    do { \
        ...
        (kip_msg_stream_create_endpoints_res_ptr)->_data[4] = (uint16)((uint16)((tinfo_block_size) & 0xffff)); \
        (kip_msg_stream_create_endpoints_res_ptr)->_data[5] = (uint16)(((tinfo_block_size) >> 16)); \
        (kip_msg_stream_create_endpoints_res_ptr)->_data[6] = (uint16)((uint16)((tinfo_period) & 0xffff)); \
        (kip_msg_stream_create_endpoints_res_ptr)->_data[7] = (uint16)(((tinfo_period) >> 16)); \
        (kip_msg_stream_create_endpoints_res_ptr)->_data[8] = (uint16)((uint16)(flags)); \
    } while (0)

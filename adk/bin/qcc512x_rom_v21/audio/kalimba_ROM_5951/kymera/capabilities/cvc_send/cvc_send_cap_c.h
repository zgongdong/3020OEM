...
//    #undef  CVC_SEND_SUPPORT_METADATA
    #define CVC_NUM_OUTPUTS     2
    #define CVC_VA_PORT         0
#else
...
typedef struct
{
    ...
    tFrmBuffer *input_stream[CVC_SEND_MAX_NUM_INPUT];     /**< Pointer to input Frame Sync Stream Maps */
    tFrmBuffer *output_stream[CVC_SEND_MAX_NUM_OUTPUT];   /**< Pointer to output Frame Sync Stream Map */

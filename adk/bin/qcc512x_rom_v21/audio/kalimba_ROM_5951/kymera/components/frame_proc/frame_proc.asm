...
$_run_frame_proc_function_table:
   ...
   LIBS_PUSH_R0_SLOW_SW_ROM_PATCH_POINT($run_frame_proc_function_table.PATCH_ID_0, r4)

   call $frame_proc.run_function_table;
...
jp_next_stream:
   ...
   // Get CBuffer for Stream and check if it is NULL
   r0 = M[r9 + $frmbuffer.CBUFFER_PTR_FIELD]; 
   if Z jump increment_stream_table_ptr;
...
jp_next_stream:
   ...
   // check if the buffer of this stream is not NULL
   NULL = M[r9 + $frmbuffer.CBUFFER_PTR_FIELD];//get the buffer pointer
   if Z jump increment_stream_table_ptr;

   // Get Stream update Function and Data Ptr
...
$frame_proc.distribute_output_stream:
   ...
   LIBS_PUSH_R0_SLOW_SW_ROM_PATCH_POINT($frame_proc.distribute_output_stream.PATCH_ID_0, r1)
...
$frame_proc.distribute_input_stream:
   ...
   LIBS_PUSH_R0_SLOW_SW_ROM_PATCH_POINT($frame_proc.distribute_input_stream.PATCH_ID_0, r1)

 ...
 */
void stream_delegate_rate_adjust_set_target_rate(EXT_OP_ID opid, unsigned target_rate)
{
    unsigned params[3];
 ...
 */
void stream_delegate_rate_adjust_set_passthrough_mode(EXT_OP_ID opid,
                                                      bool enable)
{
    unsigned params[2];
 ...
 */
void stream_delegate_rate_adjust_set_current_rate(EXT_OP_ID opid, unsigned rate)
{
    unsigned params[3];

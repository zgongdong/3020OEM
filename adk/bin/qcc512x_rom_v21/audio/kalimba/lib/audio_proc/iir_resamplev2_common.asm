...
#include "iir_resamplev2_util_asm_defs.h"
...
.MODULE $M.iir_resampler.DynMemory;
   ...
   .VAR/DMCONST16 Low_MIPS_Table[] =   
      ...
      $shared_memory_ids.IIRV2_RESAMPLER_Up_441_Down_160, $shared_memory_ids.IIRV2_RESAMPLER_Up_441_Down_160_low_mips,
      $shared_memory_ids.IIRV2_RESAMPLER_Up_160_Down_441, $shared_memory_ids.IIRV2_RESAMPLER_Up_160_Down_441_low_mips;
...
$_iir_resamplerv2_release_config:
   ...
   pushm <r4, r5>;
   r4 = M[$_iir_resamplev2_head];
   r5 = r0;
   
next_table1:   
   r0 = r5;
   r2 = M[r4 + $iir_resamplev2_util.IIR_TABLE_INSTANCE_struct.EXTERNAL_DESCRIPTOR_FIELD];
   r1 = M[r4 + $iir_resamplev2_util.IIR_TABLE_INSTANCE_struct.INTERNAL_DESCRIPTOR_FIELD];
   // pick the external descriptor if no internal descriptor
   if Z r1 = r2;
   Null = r1;
   // if no internal/external descriptor there is nothing to do
   if Z jump exit1;
   PUSH_ALL_C;
   ...
   Null = r0;
   if NZ jump exit1;
   // are there any more tables to search for our identifier?
   r4 = M[r4 + $iir_resamplev2_util.IIR_TABLE_INSTANCE_struct.NEXT_FIELD];
   if NZ jump next_table1;

exit1:
   // restore r4, r5 and the stack and exit
   popm <r4, r5>;
   jump $pop_rLink_and_rts;

 ...
 * Shared memory IDs.
 *
 * This enumeration provides unique IDs for the users of the shared memory API
 * (shared_malloc(), etc).
 * To create a new id, add a new entry to the enumeration.
 */
typedef enum{
    /*
     * IDs 0x0000-0x7FFF are reserved for Qualcomm use (all the IDs in the
     *   Qualcomm-supplied version of this file are in this range).
     * IDs 0x8000-0xBFFF are available for private use in customer projects.
     *   (There is no process to prevent different customers re-using the
     *   same IDs.)
     * IDs 0xC000-0xFFFF are reserved for eXtension programme partners.
     *   Contact Qualcomm to have a range reserved for your exclusive use,
     *   allowing your code to coexist with others' (this is only necessary
     *   if your code uses the shared memory API).
     */
    ...
    ****************************************************************************/
    FILTER_BANK_FRM240_P960_FFT512,
    FILTER_BANK_FRM240_P480_FFT512,
    ...
    FILTER_BANK_FRM240_P960_FFT512_PROTO,
    FILTER_BANK_FRM240_P480_FFT512_PROTO,
    ...
    ****************************************************************************/
    ...
    IIRV2_RESAMPLER_Up_160_Down_441_low_mips,
    IIRV2_RESAMPLER_Up_441_Down_160_low_mips,
    ...
    ****************************************************************************/
    ...
    CVC_DMS100_INTERNAL3_UWB_FB,
    CVC_DMS100_INTERNAL4_UWB_FB,
    ...
    CVC_DMS100_INTERNAL1_SWB,
    CVC_DMS100_INTERNAL2_SWB,
    CVC_DMS100_INTERNAL3_SWB,
    CVC_DMS100_INTERNAL4_SWB,
    CVC_DMS100_INTERNAL5_SWB,
    CVC_DMS100_INTERNAL6_SWB,
    ...
    CVC_ASF100_MODE_SIN_COEF,
    CVC_ASF100_CONST_NB,
    CVC_ASF100_CONST_WB,
    CVC_ASF100_CONST_UWB,
    CVC_ASF100_CONST_SWB,
    CVC_ASF100_CONST_FB,
    CVC_ASF100_MODE_NB,
    CVC_ASF100_MODE_WB,
    CVC_ASF100_MODE_UWB,
    ...
    /* CELT Offload */
    CELT_OFFLOAD_SHARED_DM1,
    CELT_OFFLOAD_SHARED_DM2
}shared_memory_id;

...
enum patch_index {
    ...
    patch_fn_stream_iso_shared_patchpoint_index,
    patch_fn_stream_iso_interface_shared_patchpoint_index,
#endif
...
#ifdef INSTALL_OP_CLIENT
    patch_fn_op_client_shared_patchpoint_index,
#endif
    patch_fn_cbuffer_shared_patchpoint_index,
...
#ifdef INSTALL_OPERATOR_KSP
    patch_fn_ksp_shared_patchpoint_index,
    patch_fn_ksp_run_shared_patchpoint_index,
#endif
    ...
    patch_fn_direct_access_shared_patchpoint_index,
#endif
    ...
    patch_fn_unpack_cbuff_to_array_shared_patchpoint_index,
    patch_fn_rtp_decode_shared_patchpoint_index,
#endif
#ifdef INSTALL_OPERATOR_SPLITTER
    patch_fn_splitter_shared_patchpoint_index,
#endif
    ...
    patch_fn_async_wbs_encode_process_data_index,
    patch_fn_async_wbs_decode_process_data_index,
    ...
    defined (INSTALL_OPERATOR_SWBS_ENC)
    patch_fn_aptx_adaptive_encode_process_data_index,
    patch_fn_aptx_adaptive_encode_shared_patchpoint_index,
#endif
#if defined (INSTALL_OPERATOR_APTX_ADAPTIVE_DECODE) || \
    defined (INSTALL_OPERATOR_SWBS_DEC)
    patch_fn_aptx_adaptive_decode_process_data_index,
    patch_fn_aptx_adaptive_decode_shared_patchpoint_index,
#endif
#ifdef INSTALL_OPERATOR_APTX_ADAPTIVE_DEMUX
    patch_fn_aptx_adaptive_demux_process_data_index,
    patch_fn_aptx_adaptive_demux_shared_patchpoint_index,
#endif
#ifdef INSTALL_OPERATOR_SWBS_ENC
    patch_fn_swbs_encode_process_data_index,
    patch_fn_swbs_encode_shared_patchpoint_index,
#endif
#ifdef INSTALL_OPERATOR_SWBS_DEC
    patch_fn_swbs_decode_process_data_index,
    patch_fn_swbs_fake_packet_index,
    patch_fn_swbs_decode_shared_patchpoint_index,
    patch_fn_swbs_decode_processing_shared_patchpoint_index,
#endif
#if defined (INSTALL_OPERATOR_APTX_ADAPTIVE_ENCODE) || \
    defined (INSTALL_OPERATOR_APTX_ADAPTIVE_DECODE) || \
    defined (INSTALL_OPERATOR_SWBS_ENC) || \
    defined (INSTALL_OPERATOR_SWBS_DEC)
    patch_fn_aptx_adaptive_common_shared_patchpoint_index,
#endif
#if defined (INSTALL_OPERATOR_AAC_DECODE) || defined (INSTALL_OPERATOR_AAC_SHUNT_DECODER)
    patch_fn_aac_decode_shared_patchpoint_index,
#endif
    ...
    patch_fn_vad_cap_create_index,
    patch_fn_vad_destroy_index,
#endif /* INSTALL_OPERATOR_VAD */
#ifdef INSTALL_OPERATOR_QVA
    patch_fn_qva_capability_shared_patchpoint_index,
    patch_fn_qva_lib_shared_patchpoint_index,
    patch_fn_qva_process_data_index,
    patch_fn_qva_opmsg_obpm_set_params_index,
    patch_fn_qva_configure_mode_change_index,
    patch_fn_qva_trigger_phrase_load_index,
#endif /* INSTALL_OPERATOR_QVA */
    ...
    patch_fn_cbuffer_copy_ex_shared_patchpoint_index,
    ...
    patch_fn_hal_clock_auraplus_audio_shared_patchpoint_index,
    patch_fn_clk_mgr_auraplus_audio_shared_patchpoint_index,
#endif /*CHIP_HAS_SEPARATE_DDS_DOMAIN*/
#endif /* INSTALL_CLK_MGR */

#ifdef INSTALL_EXTERNAL_MEM
    patch_fn_extmem_shared_patchpoint_index,
    patch_fn_ext_buffer_shared_patchpoint_index,
#endif /* INSTALL_EXTERNAL_MEM */

#ifdef INSTALL_OPERATOR_CONVERT_FROM_AUDIO
    patch_fn_convert_from_audio_cap_shared_patchpoint_index,
#endif /* INSTALL_OPERATOR_CONVERT_FROM_AUDIO */

#ifdef INSTALL_OPERATOR_CONVERT_TO_AUDIO
    patch_fn_convert_to_audio_cap_shared_patchpoint_index,
#endif /* INSTALL_OPERATOR_CONVERT_TO_AUDIO */
    ...
    patch_fn_thread_offload_shared_patchpoint_index,
    patch_fn_thread_offload_rpc_shared_patchpoint_index,
#endif /* INSTALL_THREAD_OFFLOAD */

    patch_fn_rate_lib_shared_patchpoint_index,
    patch_fn_rate_adjust_op_shared_patchpoint_index,
    patch_fn_heap_shared_patchpoint_index,
    patch_fn_xppmalloc_index,
...
#ifdef ENABLE_NAPIER_SHARED_PATCH_POINTS
    /*
     * ToDo: This must be cleaned up together with the configs in
     *  such a way that we have an INSTALL define for these functions
     */
	patch_fn_comms_interface_shared_patchpoint_index,
    patch_fn_comms_bt_addr_resp_handler_shared_patchpoint_index,
    patch_fn_comms_bulk_data_interface_handler_shared_patchpoint_index,
    patch_fn_comms_shutdown_handler_shared_patchpoint_index,
    patch_fn_comms_interface_config_handler_shared_patchpoint_index,
    patch_fn_comms_dsp_license_handler_shared_patchpoint_index,
    patch_fn_comms_mib_update_handler_shared_patchpoint_index,
    patch_fn_comms_native_clk_handler_shared_patchpoint_index,
    patch_fn_comms_random_number_handler_shared_patchpoint_index,
    patch_fn_comms_task_handler_shared_patchpoint_index,
    patch_fn_comms_sco_msg_handler_shared_patchpoint_index,
	patch_fn_local_clkn_shared_patchpoint_index,
    patch_fn_set_memory_bank_permissions_shared_patchpoint_index,
    patch_fn_sco_mgr_shared_patchpoint_index,
    patch_fn_cvsd_loopback_shared_patchpoint_index,
	patch_fn_mib_loader_shared_patchpoint_index,
	patch_fn_mib_loader_install_shared_patchpoint_index,

#ifdef INSTALL_CAP_DOWNLOAD_MGR
    patch_fn_cap_download_mgr_fetch_napier_shared_patchpoint_index,
    patch_fn_cap_download_interface_shared_patchpoint_index,
#endif
#endif

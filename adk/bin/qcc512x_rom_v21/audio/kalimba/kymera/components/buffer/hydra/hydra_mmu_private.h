...
#else /* __KCC__ */
#define DM1_ADDRESS(x) ((uintptr_t)(x))
#endif /* __KCC__ */
...
/* Napier can read/write to external address via AUDIO AHB space, these macros tranlate external memory address to
 *  DM1 addresses and viceversa.*/
#define DM1_TO_EXTERNAL_ADDRESS(DM1_ADDRESS) (((uintptr_t)(DM1_ADDRESS)&AUDIO_AHB_SPACE_KALIMBA_DM_SIZE)|AUDIO_AHB_SPACE_KALIMBA_DM_START_ADDRESS)
#define EXTERNAL_ADDRESS_TO_DM1(AHB_ADDRESS) (((uintptr_t)(AHB_ADDRESS)&AUDIO_AHB_SPACE_KALIMBA_DM_SIZE))
#define IS_DM1_ADDRESS(ADDRESS)              ((uintptr_t)(ADDRESS)&AUDIO_AHB_SPACE_KALIMBA_DM_SIZE) == (uintptr_t)(ADDRESS)

#else

#define DM1_TO_EXTERNAL_ADDRESS(DM1_ADDRESS) ((uintptr_t)(DM1_ADDRESS))
#define EXTERNAL_ADDRESS_TO_DM1(AHB_ADDRESS) ((uintptr_t)(AHB_ADDRESS))
#define IS_DM1_ADDRESS(ADDRESS)              (DM1_ADDRESS(ADDRESS) == (uintptr_t)(ADDRESS))

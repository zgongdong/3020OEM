...
#include "opmgr.h"
#include "opmgr_operator_data.h"
#include "opmgr_for_adaptors.h"
#include "opmgr_for_ops.h"
#include "opmgr_for_stream.h"
...
#if defined(INSTALL_DUAL_CORE_SUPPORT) || defined(AUDIO_SECOND_CORE)
#define OPMGR_ON_SAME_CORE(x) IPC_ON_SAME_CORE((IPC_PROCESSOR_ID_NUM)(x))

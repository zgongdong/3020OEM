...
/**  
 * \brief Copy a (word-sized) value from a P0 private RAM variable to the equivalent in P1
 * 
 * \param Pointer to the variable to update
 */
extern void thread_offload_update_p1_dm_location(unsigned *p0_address);

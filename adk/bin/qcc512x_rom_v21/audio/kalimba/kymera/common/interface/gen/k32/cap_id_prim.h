...
/*******************************************************************************
  ...
  DESCRIPTION
    Capability IDs 0x0000-0x3FFF are reserved for Qualcomm-provided
    capabilities built in to a Kymera image. Capability IDs 0x4000-0x7FFF are
    reserved for Qualcomm-provided downloadable capabilities. Capability IDs
    0x8000-0xBFFF are reserved. Capability IDs 0xC000-0xC0FF are for private
    use in customer projects. Capability IDs 0xC100-0xFFFF are reserved for
    use by Qualcomm eXtension programme partners. Contact Qualcomm to get a
    range reserved for your exclusive use, allowing your capabilities to
    coexist with others'.
 ...
 VALUES
    ...
    CVCSPKR4MIC_CIRC_SEND_FB
                   - CVC 4 Mic Speakerphone circular
    CVCSPKR3MIC_CIRC_VA_SEND_WB
                   - CVC 3 Mic Speakerphone circular, VA 4 beam, with AEC
    CVCSPKR3MIC_CIRC_VA4B_SEND_WB
                   - CVC 3 Mic Speakerphone circular, VA 4 beam, without AEC
    CVCSPKR2MIC_VA3B_WB
                   - CVC 2 Mic Speakerphone, VA 3 beam
    CVCHS2MIC_WAKEON_WB
                   - CVC 2 Mic Headset Mono VA Wake On
    CVCHS2MIC_BARGEIN_WB
                   - CVC 2 Mic Headset Mono VA Bargein
    DBE_FULLBAND
                   - DBE_FULLBAND
    ...
    APTX_CLASSIC_DEMUX
                   - APTX Classic Stereo Demux
    ANC_TUNING
                   - ANC tuning
    RATE_ADJUST
                   - Standalone SW Rate Adjustment
    ASYNC_WBS_ENC
                   - Async WBS encoder
    ASYNC_WBS_DEC
                   - Async WBS decoder
    SWITCHED_PASSTHROUGH_CONSUMER
                   - Switched Passthrough Consumer
    APTX_ADAPTIVE_DEMUX
                   - aptX adaptive demux
    APTX_ADAPTIVE_DECODE
                   - aptX adaptive decoder
    APTX_ADAPTIVE_ENCODE
                   - aptX adaptive encoder
    CAP_ID_SWBS_ENC
                   - Super Wideband Speech aptX adaptive encoder
    CAP_ID_SWBS_DEC
                   - Super Wideband Speech aptX adaptive decoder
    CAP_ID_VA_GRAPH_MANAGER
                   - VA Graph Manager (operator client)
    CONVERT_FROM_AUDIO
                   - Audio convert to 16-bit unpacked
    CONVERT_TO_AUDIO
                   - Audio convert to 16-bit unpacked
    KSP
    ...
    TEST_ASYNC_WBS_LINK
                   - Capability for connecting the async_wbs encoder and
                     decoder.
    TEST_CONSUMER
    ...
    DOWNLOAD_QVA
                   - Downloadable Phrase recogintion using Snapdragon Voice
                     Activation
    DOWNLOAD_APTX_CLASSIC_DEMUX
                   - Downloadable aptx classic demux
    DOWNLOAD_APTXHD_DECODER
                   - Downloadable aptxhd raw decoder
    DOWNLOAD_APTXHD_A2DP_ENCODER
                   - Downloadable High-Quality APT-X HD Audio Encoder
    DOWNLOAD_APTXHD_SHUNT_DECODER
                   - Downloadable APTXHD decoder over A2DP / Shunt (i.e. with
                     L2CAP headers)
    DOWNLOAD_APTX_CLASSIC_ENCODER
                   - Downloadable APTX Classic Encoder
    DOWNLOAD_APTX_LOW_LATENCY_ENCODER
                   - Downloadable APTX LL Encoder
    DOWNLOAD_APTXHD_ENCODER
                   - Downloadable APTXHD Encoder
    DOWNLOAD_APTX_CLASSIC_MONO_DECODER
                   - Downloadable APTX Classic Mono Decoder
    DOWNLOAD_APTXHD_MONO_DECODER
                   - Downloadable APTX HD Mono Decoder
    DOWNLOAD_APTX_CLASSIC_MONO_DECODER_NO_AUTOSYNC
                   - Downloadable APTX Classic Mono Decoder without autosync
    DOWNLOAD_APTXHD_MONO_DECODER_NO_AUTOSYNC
                   - Downloadable APTX HD Mono Decoder without autosync
    DOWNLOAD_APTX_CLASSIC_MONO_ENCODER
                   - Downloadable APTX Classic Mono encoder with autosync
    DOWNLOAD_APTX_CLASSIC_MONO_ENCODER_NO_AUTOSYNC
                   - Downloadable APTX Classic Mono encoder without autosync
    DOWNLOAD_APTXHD_MONO_ENCODER
                   - Downloadable APTX HD Mono encoder with autosync
    DOWNLOAD_APTXHD_MONO_ENCODER_NO_AUTOSYNC
                   - Downloadable APTX HD Mono encoder without autosync
    DOWNLOAD_RATE_ADJUST
                   - Downloadable standalone SW Rate Adjustment
    DOWNLOAD_ASYNC_WBS_ENC
                   - Downloadable WBS non-sco Encoder
    DOWNLOAD_ASYNC_WBS_DEC
                   - Downloadable WBS non-sco Decoder
    DOWNLOAD_SWITCHED_PASSTHROUGH_CONSUMER
                   - Downloadable Switched Passthrough Consumer
    DOWNLOAD_APTX_ADAPTIVE_DEMUX
                   - Downloadable aptX Adaptive Demux
    DOWNLOAD_APTX_ADAPTIVE_DECODE
                   - Downloadable aptX Adaptive Decoder
    DOWNLOAD_ANC_TUNING
                   - ANC tuning
    DOWNLOAD_DIRECT_ACCESS_TEST
                   - Direct access testing
    DOWNLOAD_APTX_ADAPTIVE_ENCODE
                   - Downloadable aptX Adaptive Encoder
    DOWNLOAD_PSKEY_TEST
                   - Download capability for the pskey kats4 tests
    DOWNLOAD_CVCSPKR3MIC_CIRC_VA_SEND_WB
                   - CVC 3 Mic Speakerphone circular, VA 4 beam, with AEC
    DOWNLOAD_CVCSPKR3MIC_CIRC_VA4B_SEND_WB
                   - CVC 3 Mic Speakerphone circular, VA 4 beam, without AEC
    DOWNLOAD_CVCSPKR2MIC_VA3B_WB
                   - CVC 2 Mic Speakerphone, VA 3 beam
    CAP_ID_DOWNLOAD_SWBS_ENC
                   - Super Wideband Speech
    CAP_ID_DOWNLOAD_SWBS_DEC
                   - Super Wideband Speech
    DOWNLOAD_VAD
                   - Downloadable Voice Activity Detection VAD
    DOWNLOAD_SOURCE_SYNC
                   - Downloadable Source Synchronisation
    DOWNLOAD_VA_GRAPH_MANAGER
                   - Downloadable Graph Manager (operator client)
    DOWNLOAD_CONVERT_FROM_AUDIO
                   - Downloadable CONVERT_FROM_AUDIO
    DOWNLOAD_CONVERT_TO_AUDIO
                   - Downloadable CONVERT_TO_AUDIO
    DOWNLOAD_CVCHS2MIC_WAKEON_WB
                   - Downloadable CVC 2 Mic Headset Mono VA Wake On
    DOWNLOAD_CVCHS2MIC_BARGEIN_WB
                   - Downloadable CVC 2 Mic Headset Mono VA Bargein
    DOWNLOAD_KSP
                   - Kymera Stream Probe, streaming of connection buffers' data
                     to a host
    DUMMY_ID_FORCE_INT
...
typedef enum
{
    ...
    CAP_ID_CVCSPKR3MIC_CIRC_VA_SEND_WB = 0x007D,
    CAP_ID_CVCSPKR3MIC_CIRC_VA4B_SEND_WB = 0x007E,
    CAP_ID_CVCSPKR2MIC_VA3B_WB = 0x007F,
    CAP_ID_CVCHS2MIC_WAKEON_WB = 0x0080,
    CAP_ID_CVCHS2MIC_BARGEIN_WB = 0x0081,
    ...
    CAP_ID_APTX_CLASSIC_DEMUX = 0x00B1,
    CAP_ID_ANC_TUNING = 0x00B2,
    CAP_ID_RATE_ADJUST = 0x00B3,
    CAP_ID_ASYNC_WBS_ENC = 0x00B4,
    CAP_ID_ASYNC_WBS_DEC = 0x00B5,
    CAP_ID_SWITCHED_PASSTHROUGH_CONSUMER = 0x00B6,
    CAP_ID_APTX_ADAPTIVE_DEMUX = 0x00B7,
    CAP_ID_APTX_ADAPTIVE_DECODE = 0x00B8,
    CAP_ID_APTX_ADAPTIVE_ENCODE = 0x00B9,
    CAP_ID_SWBS_ENC = 0x00BA,
    CAP_ID_SWBS_DEC = 0x00BB,
    CAP_ID_VA_GRAPH_MANAGER = 0x00BC,
    ...
    CAP_ID_DOWNLOAD_QVA = 0x406C,
    CAP_ID_DOWNLOAD_APTX_CLASSIC_DEMUX = 0x406D,
    CAP_ID_DOWNLOAD_APTXHD_DECODER = 0x406E,
    CAP_ID_DOWNLOAD_APTXHD_A2DP_ENCODER = 0x406F,
    CAP_ID_DOWNLOAD_APTXHD_SHUNT_DECODER = 0x4070,
    CAP_ID_DOWNLOAD_APTX_CLASSIC_ENCODER = 0x4071,
    CAP_ID_DOWNLOAD_APTX_LOW_LATENCY_ENCODER = 0x4072,
    CAP_ID_DOWNLOAD_APTXHD_ENCODER = 0x4073,
    CAP_ID_DOWNLOAD_APTX_CLASSIC_MONO_DECODER = 0x4074,
    CAP_ID_DOWNLOAD_APTXHD_MONO_DECODER = 0x4075,
    CAP_ID_DOWNLOAD_APTX_CLASSIC_MONO_DECODER_NO_AUTOSYNC = 0x4076,
    CAP_ID_DOWNLOAD_APTXHD_MONO_DECODER_NO_AUTOSYNC = 0x4077,
    CAP_ID_DOWNLOAD_APTX_CLASSIC_MONO_ENCODER = 0x4078,
    CAP_ID_DOWNLOAD_APTX_CLASSIC_MONO_ENCODER_NO_AUTOSYNC = 0x4079,
    CAP_ID_DOWNLOAD_APTXHD_MONO_ENCODER = 0x407A,
    CAP_ID_DOWNLOAD_APTXHD_MONO_ENCODER_NO_AUTOSYNC = 0x407B,
    CAP_ID_DOWNLOAD_RATE_ADJUST = 0x407C,
    CAP_ID_DOWNLOAD_ASYNC_WBS_ENC = 0x407D,
    CAP_ID_DOWNLOAD_ASYNC_WBS_DEC = 0x407E,
    CAP_ID_DOWNLOAD_SWITCHED_PASSTHROUGH_CONSUMER = 0x407F,
    CAP_ID_DOWNLOAD_APTX_ADAPTIVE_DEMUX = 0x4080,
    CAP_ID_DOWNLOAD_APTX_ADAPTIVE_DECODE = 0x4081,
    CAP_ID_DOWNLOAD_ANC_TUNING = 0x4082,
    CAP_ID_DOWNLOAD_DIRECT_ACCESS_TEST = 0x4083,
    CAP_ID_DOWNLOAD_APTX_ADAPTIVE_ENCODE = 0x4084,
    CAP_ID_DOWNLOAD_PSKEY_TEST = 0x4085,
    CAP_ID_DOWNLOAD_CVCSPKR3MIC_CIRC_VA_SEND_WB = 0x4086,
    CAP_ID_DOWNLOAD_CVCSPKR3MIC_CIRC_VA4B_SEND_WB = 0x4087,
    CAP_ID_DOWNLOAD_CVCSPKR2MIC_VA3B_WB = 0x4088,
    CAP_ID_DOWNLOAD_SWBS_ENC = 0x4089,
    CAP_ID_DOWNLOAD_SWBS_DEC = 0x408A,
    CAP_ID_DOWNLOAD_VAD = 0x408B,
    CAP_ID_DOWNLOAD_SOURCE_SYNC = 0x408C,
    CAP_ID_DOWNLOAD_VA_GRAPH_MANAGER = 0x408E,

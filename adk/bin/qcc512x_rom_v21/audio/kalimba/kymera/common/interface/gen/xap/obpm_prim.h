...
/*******************************************************************************
  ...
  DESCRIPTION
    Request message for getting licence status of a licenced component. Uses
    variable length.

  MEMBERS
    prod_id - Product ID words (variable number)
...
/*******************************************************************************
  ...
  DESCRIPTION
    Response message with licence status of the component.

...
.CONST $cvc_send.cap.VAD_DC_COEFFS                       32*ADDR_PER_WORD;
.CONST $cvc_send.cap.AEC_MODE                            33*ADDR_PER_WORD;
.CONST $cvc_send.cap.FILTERBANK_CONFIG                   34*ADDR_PER_WORD;
.CONST $cvc_send.cap.NDVC_SHARE_PTR_FIELD                35*ADDR_PER_WORD;

// State Info                                                 
.CONST $cvc_send.cap.MGDC_STATE_FIELD                    36*ADDR_PER_WORD; 
.CONST $cvc_send.cap.MGDC_STATE_PTR_FIELD                37*ADDR_PER_WORD;

// Misc Control Data                                          
.CONST $cvc_send.cap.OP_FEATURE_REQUESTED                38*ADDR_PER_WORD;
.CONST $cvc_send.cap.CAPABILITY_ID                       39*ADDR_PER_WORD;
.CONST $cvc_send.cap.CAP_ROOT_PTR_FIELD                  40*ADDR_PER_WORD;
.CONST $cvc_send.cap.HOST_MODE                           41*ADDR_PER_WORD;
.CONST $cvc_send.cap.OBPM_MODE                           42*ADDR_PER_WORD;
.CONST $cvc_send.cap.OVR_CONTROL                         43*ADDR_PER_WORD;
.CONST $cvc_send.cap.ALGREINIT                           44*ADDR_PER_WORD; 

.CONST $cvc_send.cap.SCRATCH_BUFFER                      45*ADDR_PER_WORD;  

.CONST $cvc_send.cap.CUR_MODE                            46*ADDR_PER_WORD;
.CONST $cvc_send.cap.DATA_VARIANT                        47*ADDR_PER_WORD;
.CONST $cvc_send.cap.MAJOR_CONFIG                        48*ADDR_PER_WORD;
.CONST $cvc_send.cap.NUM_MICS                            49*ADDR_PER_WORD;
.CONST $cvc_send.cap.MIC_CONFIG                          50*ADDR_PER_WORD;
.CONST $cvc_send.cap.CAP_DATA                            51*ADDR_PER_WORD;
.CONST $cvc_send.cap.DYN_MAIN                            52*ADDR_PER_WORD;
.CONST $cvc_send.cap.DYN_LINKER                          53*ADDR_PER_WORD;

.CONST $cvc_send.cap.MUTE_CONTROL_PTR                    54*ADDR_PER_WORD;
.CONST $cvc_send.cap.HOST_MUTE                           55*ADDR_PER_WORD;
.CONST $cvc_send.cap.OBPM_MUTE                           56*ADDR_PER_WORD;
.CONST $cvc_send.cap.CURRENT_MUTE                        57*ADDR_PER_WORD;

.CONST $cvc_send.cap.FRAME_SIZE_FIELD                    58*ADDR_PER_WORD;
.CONST $cvc_send.cap.SAMPLE_RATE_FIELD                   59*ADDR_PER_WORD;
.CONST $cvc_send.cap.NUM_VA_OUTPUTS                      60*ADDR_PER_WORD;
.CONST $cvc_send.cap.OMNI_MODE_HOST_FIELD                61*ADDR_PER_WORD;
.CONST $cvc_send.cap.OMNI_MODE_OBPM_FIELD                62*ADDR_PER_WORD;
.CONST $cvc_send.cap.OMNI_MODE_PTR_FIELD                 63*ADDR_PER_WORD;
.CONST $cvc_send.cap.SECURITY.KEY_FIELD                  64*ADDR_PER_WORD;

.CONST $cvc_send.cap.PARMS_DEF_FIELD                     66*ADDR_PER_WORD;//Secure Data is 2 words

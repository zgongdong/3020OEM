...
const handler_lookup_struct async_wbs_enc_handler_table =
{
    ...
    async_wbs_enc_get_data_format,  /* OPCMD_DATA_FORMAT */
    async_wbs_enc_get_sched_info    /* OPCMD_GET_SCHED_INFO */
};
...
{
    return (ASYNC_WBS_ENC_OP_DATA *) base_op_get_instance_data(op_data);
}
        ...
        unsigned *response_id, void **response_data)
{
    ...
    switch (terminal_id)
    {
        case OUTPUT_TERMINAL_ID:
            ...
            {
                cbuffer_set_usable_octets(wbs_enc->wbs.buffers.op_buffer,
...
bool async_wbs_enc_get_data_format(OPERATOR_DATA *op_data, void *message_data, unsigned *response_id,
        void **response_data)
{
...
bool async_wbs_enc_get_sched_info(OPERATOR_DATA *op_data, void *message_data, unsigned *response_id,
        void **response_data)
{
    return sco_common_get_sched_info(op_data, message_data, response_id, response_data,
            WBS_ENC_DEFAULT_INPUT_BLOCK_SIZE, ASYNC_WBS_MIN_OUTPUT_BLOCK_SIZE);
}

                 ...
                 const bdaddr * bt_addr, uint16 lt_addr)
{
    ...
    ipc_send(IPC_SIGNAL_ID_TEST2_TX_DATA, &ipc_send_prim, sizeof(ipc_send_prim));
    (void)ipc_recv(IPC_SIGNAL_ID_TEST2_TX_DATA_RSP, &ipc_recv_prim);
                  ...
                  const bdaddr * bt_addr, uint16 lt_addr)
{
    ...
    ipc_send(IPC_SIGNAL_ID_TEST2_RX_START, &ipc_send_prim, sizeof(ipc_send_prim));
    (void)ipc_recv(IPC_SIGNAL_ID_TEST2_RX_START_RSP, &ipc_recv_prim);
    return ipc_recv_prim.ret;
}

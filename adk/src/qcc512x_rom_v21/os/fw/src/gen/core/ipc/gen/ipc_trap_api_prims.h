...
typedef struct IPC_TRANSFORM_CONVERT_CLOCK {
    IPC_HEADER header;
    uint16 source;
    uint16 sink;
} IPC_TRANSFORM_CONVERT_CLOCK;

typedef struct IPC_TRANSFORM_HASH {
    IPC_HEADER header;
    uint16 source;
    uint16 sink;
} IPC_TRANSFORM_HASH;
...
typedef struct IPC_PS_NEXT_KEY {
    IPC_HEADER header;
    uint16 value;
    uint16* key;
} IPC_PS_NEXT_KEY;

typedef struct IPC_PS_NEXT_AUDIO_KEY {
    IPC_HEADER header;
    uint16 value;
    uint32* key;
} IPC_PS_NEXT_AUDIO_KEY;

typedef struct IPC_PS_DEFRAG_BLOCKING {
    IPC_HEADER header;
} IPC_PS_DEFRAG_BLOCKING;
...
typedef struct IPC_VM_GET_ACL_MODE {
    IPC_HEADER header;
    const TP_BD_ADDR_T * acl_address;
} IPC_VM_GET_ACL_MODE;

typedef struct IPC_VM_GET_ACL_ROLE {
    IPC_HEADER header;
    const TP_BD_ADDR_T * acl_address;
} IPC_VM_GET_ACL_ROLE;
...
typedef struct IPC_RA_PARTITION_OPEN {
    IPC_HEADER header;
    raPartition_handle * handle;
    raPartition_info * partition_info;
} IPC_RA_PARTITION_OPEN;

typedef struct IPC_RA_PARTITION_CLOSE {
    IPC_HEADER header;
    raPartition_handle * handle;
} IPC_RA_PARTITION_CLOSE;

typedef struct IPC_RA_PARTITION_ERASE {
    IPC_HEADER header;
    raPartition_handle * handle;
    uint32 offset;
} IPC_RA_PARTITION_ERASE;

typedef struct IPC_RA_PARTITION_WRITE {
    IPC_HEADER header;
    raPartition_handle * handle;
    uint32 offset;
    uint32 length;
    const uint8 * buffer;
} IPC_RA_PARTITION_WRITE;

typedef struct IPC_RA_PARTITION_READ {
    IPC_HEADER header;
    raPartition_handle * handle;
    uint32 offset;
    uint32 length;
    uint8 * buffer;
} IPC_RA_PARTITION_READ;

typedef struct IPC_RA_PARTITION_BG_ERASE {
    IPC_HEADER header;
    raPartition_handle * handle;
    uint32 offset;
} IPC_RA_PARTITION_BG_ERASE;
...
typedef struct IPC_RAPARTITION_RESULT_RSP {
    IPC_HEADER header;
    raPartition_result ret;
} IPC_RAPARTITION_RESULT_RSP;
...
typedef union IPC_RSP {
    ...
    IPC_RAPARTITION_RESULT_RSP ipc_rapartition_result_rsp;

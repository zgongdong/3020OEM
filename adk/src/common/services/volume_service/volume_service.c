...
{
    DEBUG_LOGF("VolumeService_IncrementAudioSourceVolume, source %u, origin %u", source, origin);
    if (AudioSources_IsVolumeControlRegistered(source) && (origin == event_origin_local))
    {
...
{
    DEBUG_LOGF("VolumeService_DecrementAudioSourceVolume, source %u, origin %u", source, origin);
    if (AudioSources_IsVolumeControlRegistered(source) && (origin == event_origin_local))
    {
...
{
    DEBUG_LOGF("VolumeService_IncrementVoiceSourceVolume, source %u, origin %u", source, origin);
    if (VoiceSources_IsVolumeControlRegistered(source) && (origin == event_origin_local))
    {
...
{
    DEBUG_LOGF("VolumeService_DecrementVoiceSourceVolume, source %u, origin %u", source, origin);
    if (VoiceSources_IsVolumeControlRegistered(source) && (origin == event_origin_local))
    {

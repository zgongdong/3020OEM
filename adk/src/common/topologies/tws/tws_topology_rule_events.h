...
#define TWSTOP_RULE_EVENT_HANDOVER                      (1ULL << 26)
#define TWSTOP_RULE_EVENT_HANDOVER_INCASE_TIMEOUT       (1ULL << 27)
#define TWSTOP_RULE_EVENT_HANDOVER_INCASE_FAILED        (1ULL << 28)

#define TWSTOP_RULE_EVENT_FORCED_ROLE_SWITCH            (1ULL << 29)
#define TWSTOP_RULE_EVENT_FORCED_ROLE_SWITCH_FAILED     (1ULL << 30)

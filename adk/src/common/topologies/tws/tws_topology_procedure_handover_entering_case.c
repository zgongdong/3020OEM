...
#define HANDOVER_ENTERING_CASE_SCRIPT(ENTRY) \
    ENTRY(proc_handover_fns, PROC_HANDOVER_NO_DELAY), \
...
DEFINE_TOPOLOGY_SCRIPT(handover_entering_case, HANDOVER_ENTERING_CASE_SCRIPT);

...
\version    
\file       handset_signalling.h
\brief	    Interface to module providing signalling to handset.
*/

#ifndef HANDSET_SIGNALLING_H
#define HANDSET_SIGNALLING_H
...
enum handset_signalling_messages
{
...
/*!< Handset signalling */
extern handsetSigTaskData  app_handset_sig;

/*! Get pointer to handset signalling data structure */
#define HandsetSigGetTaskData() (&app_handset_sig)

/*! @brief Initialise the handset signalling module.
 */
bool appHandsetSigInit(Task init_task);

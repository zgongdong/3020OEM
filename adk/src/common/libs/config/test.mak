...
CONFIG_FEATURES:=CONFIG_TEST_SRC
...
CONFIG_DIRS_FILTER:= a2dp aghfp anc audio audio_plugin_common audio_plugin_if avrcp bdaddr byte_utils \
                     ...
                     iap2 input_event_manager kalimba_standard_messages leds_flash leds_manager leds_manager_if leds_rom library mapc md5 message_broker obex obex_parse pbapc \
                     pblock pio_common power power_onchip power_onchip_adapter print region sdp_parse service spp_common sppc spps swat upgrade usb_device_class \

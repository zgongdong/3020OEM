...
/*!
    \breif Connection library representation of IRK(Identity Resolving Key).
*/
typedef struct 
{ 
    uint16 irk[8]; 
...
/*!
    @brief This function allows the IRK to replaced in the device in the 
		specified device in the TDL

    @return
*/
bool ConnectionReplaceIrk(Task theAppTask, const bdaddr *peer_addr, cl_irk* irk);

...
class CMockGeneratorPluginArray
  ...
  def mock_function_declarations(function)
    ...
    if (function[:return][:void?])
      return "#define #{function[:name]}_ExpectWithArray(#{args_call}) #{function[:name]}_CMockExpectWithArray(__LINE__, #{args_call})\n" +
             "void #{function[:name]}_CMockExpectWithArray(UNITY_LINE_TYPE cmock_line, const char* cmock_file, #{args_string});\n"
    else
      return "#define #{function[:name]}_ExpectWithArrayAndReturn(#{args_call}, cmock_retval) #{function[:name]}_CMockExpectWithArrayAndReturn(__LINE__, #{args_call}, cmock_retval)\n" +
             "void #{function[:name]}_CMockExpectWithArrayAndReturn(UNITY_LINE_TYPE cmock_line, const char* cmock_file, #{args_string}, #{function[:return][:str]});\n"
    end
  end
  ...
  def mock_interfaces(function)
    ...
    if (function[:return][:void?])
      lines << "void #{func_name}_CMockExpectWithArray(UNITY_LINE_TYPE cmock_line, const char* cmock_file, #{args_string})\n"
    else
      lines << "void #{func_name}_CMockExpectWithArrayAndReturn(UNITY_LINE_TYPE cmock_line, const char* cmock_file, #{args_string}, #{function[:return][:str]})\n"
    end
    lines << "{\n"

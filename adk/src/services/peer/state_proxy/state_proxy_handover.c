...
static void stateProxy_Commit(bool is_primary)
{
    ...
    if (is_primary)
    {
        ...
        stateProxy_GetLocalData()->handset_tws = stateProxy_GetRemoteData()->handset_tws;
        BdaddrSetZero(&stateProxy_GetRemoteData()->handset_addr);
        stateProxy_GetRemoteData()->handset_tws = DEVICE_TWS_UNKNOWN;
    ...
    else
    {
        ...
        stateProxy_GetLocalData()->handset_tws = DEVICE_TWS_UNKNOWN;

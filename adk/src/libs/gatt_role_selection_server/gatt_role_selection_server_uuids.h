...
#define UUID128_ROLE_SEL_SHADOWING_STATE    00,00,eb,20,d1,02,11,e1,9b,23,00,02,5b,00,a5,a5
...
#define UUID_ROLE_SEL_SHADOWING_STATE       UUID128_ROLE_SEL_FORMAT_GATT_DB(UUID128_ROLE_SEL_SHADOWING_STATE)

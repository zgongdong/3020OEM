...
{
    DEBUG_LOGF("BredrScanManager_InquiryScanRelease client %d", client);
...
{
    DEBUG_LOGF("BredrScanManager_PageScanRelease client %d", client);
...
static void scanManager_HandleClDmLocalNameComplete(CL_DM_LOCAL_NAME_COMPLETE_T *msg)
{
    ...
    DEBUG_LOGF("scanManager_HandleClDmLocalNameComplete, status %d", msg->status);

...
/*!< Handset signalling */
handsetSigTaskData  app_handset_sig;
...
{
    handsetSigTaskData* handset_sig = HandsetSigGetTaskData();
...
/*! @brief Get HFP lock for sending coGetHandsetSigal message to request TX to handset. */

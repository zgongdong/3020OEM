...
const uint16 private_key[FAST_PAIR_PRIVATE_KEY_LEN/2] = SCRAMBLED_ASPK;
...
static void fastpair_deserialise_persistent_device_data(device_t device, void *buf, uint8 offset)
{
    UNUSED(offset);

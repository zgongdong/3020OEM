...
\file
\brief      Implementation of mirror A2DP audio source interface.
*/
...
/*! \brief Clear stored connect parameters for the source from the mirror profile
        a2dp state.

    \param source The audio source.
 */
void MirrorProfile_ClearAudioSourceParameters(audio_source_t source);

...
{
    DEBUG_LOG("leAdvertisingManager_AddDataItemToAdvert");
...
{
    DEBUG_LOG("leAdvertisingManager_AddDataItemToScanRsp");
...
static void leAdvertisingManager_ProcessDataItem(const le_adv_data_item_t* item, const le_adv_data_params_t* params)
{
    if(item->data && item->size)
    {
        ...
        DEBUG_LOG("leAdvertisingManager_ProcessDataItem %d", data_type);
...
static void leAdvertisingManager_ProcessClientData(le_adv_mgr_register_handle client_handle, const le_adv_data_params_t* params)
{
    ...
    if(num_items)
    {
        DEBUG_LOG("leAdvertisingManager_ProcessClientData num_items %d", num_items);

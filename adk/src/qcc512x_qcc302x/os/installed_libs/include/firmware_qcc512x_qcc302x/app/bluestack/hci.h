...
/* All CSR vendor specific commands use 0 for the OCF */
#define HCI_QTIL_VENDOR_SPECIFIC_OCF   ((hci_op_code_t)0x0000)
...
/* 5.1 Feature */
#define HCI_READ_LOCAL_SIMPLE_PAIRING_OPTIONS ((hci_op_code_t)HCI_INFO | 0x000C)
...
#define HCI_ULP_SET_EA_RANDOM_ADDR                        ((hci_op_code_t)HCI_ULP | 0x0035)
#define HCI_ULP_SET_EA_PARAMS                             ((hci_op_code_t)HCI_ULP | 0x0036)
#define HCI_ULP_SET_EA_DATA                               ((hci_op_code_t)HCI_ULP | 0x0037)
#define HCI_ULP_SET_EA_SCAN_RESP_DATA                     ((hci_op_code_t)HCI_ULP | 0x0038)
#define HCI_ULP_EA_ENABLE                                 ((hci_op_code_t)HCI_ULP | 0x0039)
#define HCI_ULP_EA_READ_MAX_ADV_DATA_LEN                  ((hci_op_code_t)HCI_ULP | 0x003a)
#define HCI_ULP_EA_READ_NUM_OF_ADV_SETS                   ((hci_op_code_t)HCI_ULP | 0x003b)
#define HCI_ULP_EA_REMOVE_ADV_SET                         ((hci_op_code_t)HCI_ULP | 0x003c)
#define HCI_ULP_EA_CLEAR_ADV_SETS                         ((hci_op_code_t)HCI_ULP | 0x003d)

/* Periodic Advertising (PA) */
#define HCI_ULP_SET_PA_PARAMS                             ((hci_op_code_t)HCI_ULP | 0x003e)
#define HCI_ULP_SET_PA_DATA                               ((hci_op_code_t)HCI_ULP | 0x003f)
#define HCI_ULP_PA_ENABLE                                 ((hci_op_code_t)HCI_ULP | 0x0040)

/* Extended Scanning (ES) */
#define HCI_ULP_SET_ES_PARAMS                             ((hci_op_code_t)HCI_ULP | 0x0041)
#define HCI_ULP_ES_ENABLE                                 ((hci_op_code_t)HCI_ULP | 0x0042)
#define HCI_ULP_ES_CREATE_CONNECTION                      ((hci_op_code_t)HCI_ULP | 0x0043)

/* Periodic Scanning (PS) */
#define HCI_ULP_PS_CREATE_PA_SYNC                         ((hci_op_code_t)HCI_ULP | 0x0044)
#define HCI_ULP_PS_CREATE_PA_SYNC_CANCEL                  ((hci_op_code_t)HCI_ULP | 0x0045)
#define HCI_ULP_PS_TERMINATE_PA_SYNC                      ((hci_op_code_t)HCI_ULP | 0x0046)
#define HCI_ULP_PS_ADD_DEVICE_TO_PA_LIST                  ((hci_op_code_t)HCI_ULP | 0x0047)
#define HCI_ULP_PS_REMOVE_DEVICE_FROM_PA_LIST             ((hci_op_code_t)HCI_ULP | 0x0048)
#define HCI_ULP_PS_CLEAR_PA_LIST                          ((hci_op_code_t)HCI_ULP | 0x0049)
#define HCI_ULP_PS_READ_PA_LIST_SIZE                      ((hci_op_code_t)HCI_ULP | 0x004a)

#define HCI_ULP_SET_PRIVACY_MODE                          ((hci_op_code_t)HCI_ULP | 0x004e)

/* Periodic Advertising Sync Transfer (PAST) */
#define HCI_ULP_SET_PA_RECEIVE_ENABLE                     ((hci_op_code_t)HCI_ULP | 0x0059)
#define HCI_ULP_PA_SYNC_TRANSFER                          ((hci_op_code_t)HCI_ULP | 0x005a)
#define HCI_ULP_PA_SET_INFO_TRANSFER                      ((hci_op_code_t)HCI_ULP | 0x005b)
#define HCI_ULP_SET_PA_SYNC_TRANSFER_PARAMS               ((hci_op_code_t)HCI_ULP | 0x005c)
#define HCI_ULP_SET_DEFAULT_PA_SYNC_TRANSFER_PARAMS       ((hci_op_code_t)HCI_ULP | 0x005d)

#define HCI_MAX_ULP_OCF                                   ((hci_op_code_t)0x005e)
...
#define HCI_EV_ULP_EXT_ADV_REPORT                      ((hci_event_code_t)0x0D)
#define HCI_EV_ULP_PERIODIC_ADV_SYNC_EST               ((hci_event_code_t)0x0E)
#define HCI_EV_ULP_PERIODIC_ADV_REPORT                 ((hci_event_code_t)0x0F)
#define HCI_EV_ULP_PERIODIC_ADV_SYNC_LOST              ((hci_event_code_t)0x10)
#define HCI_EV_ULP_SCAN_TIMEOUT                        ((hci_event_code_t)0x11)
#define HCI_EV_ULP_ADV_SET_TERMINATED                  ((hci_event_code_t)0x12)
#define HCI_EV_ULP_SCAN_REQ_RECEIVED                   ((hci_event_code_t)0x13)
#define HCI_EV_ULP_CHANNEL_SELECTION_ALGORITHM         ((hci_event_code_t)0x14)
#define HCI_EV_ULP_PA_SYNC_TRANSFER_RECEIVED           ((hci_event_code_t)0x18)
...
#define HCI_READ_LOCAL_SIMPLE_PAIRING_OPTIONS_LEN ((uint8_t) 0)
...
#define HCI_ULP_SET_EA_RANDOM_ADDR_PARAM_LEN                        ((uint8_t)  7)
#define HCI_ULP_SET_EA_PARAMS_PARAM_LEN                             ((uint8_t) 25)
#define HCI_ULP_SET_EA_DATA_PARAM_LEN                               ((uint8_t)  4) /* Variable */
#define HCI_ULP_SET_EA_SCAN_RESP_DATA_PARAM_LEN                     ((uint8_t)  4) /* Variable */
#define HCI_ULP_EA_ENABLE_PARAM_LEN                                 ((uint8_t)  6) /* Variable */
#define HCI_ULP_EA_READ_MAX_ADV_DATA_LEN_PARAM_LEN                  ((uint8_t)  0)
#define HCI_ULP_EA_READ_NUM_OF_ADV_SETS_PARAM_LEN                   ((uint8_t)  0)
#define HCI_ULP_EA_REMOVE_ADV_SET_PARAM_LEN                         ((uint8_t)  1)
#define HCI_ULP_EA_CLEAR_ADV_SETS_PARAM_LEN                         ((uint8_t)  0)
#define HCI_ULP_SET_PA_PARAMS_PARAM_LEN                             ((uint8_t)  7)
#define HCI_ULP_SET_PA_DATA_PARAM_LEN                               ((uint8_t)  3) /* Variable */
#define HCI_ULP_PA_ENABLE_PARAM_LEN                                 ((uint8_t)  2)
#define HCI_ULP_SET_ES_PARAMS_PARAM_LEN                             ((uint8_t)  8) /* Variable */
#define HCI_ULP_ES_ENABLE_PARAM_LEN                                 ((uint8_t)  6)
#define HCI_ULP_ES_CREATE_CONNECTION_PARAM_LEN                      ((uint8_t) 26) /* Variable */
#define HCI_ULP_PS_CREATE_PA_SYNC_PARAM_LEN                         ((uint8_t) 14)
#define HCI_ULP_PS_CREATE_PA_SYNC_CANCEL_PARAM_LEN                  ((uint8_t)  0)
#define HCI_ULP_PS_TERMINATE_PA_SYNC_PARAM_LEN                      ((uint8_t)  2)
#define HCI_ULP_PS_ADD_DEVICE_TO_PA_LIST_PARAM_LEN                  ((uint8_t)  8)
#define HCI_ULP_PS_REMOVE_DEVICE_FROM_PA_LIST_PARAM_LEN             ((uint8_t)  8)
#define HCI_ULP_PS_CLEAR_PA_LIST_PARAM_LEN                          ((uint8_t)  0)
#define HCI_ULP_PS_READ_PA_LIST_SIZE_PARAM_LEN                      ((uint8_t)  0)
#define HCI_ULP_SET_PA_RECEIVE_ENABLE_PARAM_LEN                     ((uint8_t)  3)
#define HCI_ULP_PA_SYNC_TRANSFER_PARAM_LEN                          ((uint8_t)  6)
#define HCI_ULP_PA_SET_INFO_TRANSFER_PARAM_LEN                      ((uint8_t)  5)
#define HCI_ULP_SET_PA_SYNC_TRANSFER_PARAMS_PARAM_LEN               ((uint8_t)  8)
#define HCI_ULP_SET_DEFAULT_PA_SYNC_TRANSFER_PARAMS_PARAM_LEN       ((uint8_t)  6)
...
#define HCI_EV_ULP_EXT_ADV_REPORT_PARAM_LEN                      ((uint8_t) 26) /* Variable */
#define HCI_EV_ULP_PERIODIC_ADV_SYNC_EST_PARAM_LEN               ((uint8_t) 16)
#define HCI_EV_ULP_PERIODIC_ADV_REPORT_PARAM_LEN                 ((uint8_t)  8) /* Variable */
#define HCI_EV_ULP_PERIODIC_ADV_SYNC_LOST_PARAM_LEN              ((uint8_t)  3)
#define HCI_EV_ULP_SCAN_TIMEOUT_PARAM_LEN                        ((uint8_t)  1)
#define HCI_EV_ULP_ADV_SET_TERMINATED_PARAM_LEN                  ((uint8_t)  6)
#define HCI_EV_ULP_SCAN_REQ_RECEIVED_PARAM_LEN                   ((uint8_t)  9)
#define HCI_EV_ULP_PA_SYNC_TRANSFER_RECEIVED_PARAM_LEN           ((uint8_t) 20)
...
#define HCI_READ_LOCAL_SIMPLE_PAIRING_OPTIONS_ARG_LEN ((uint8_t) 6)
...
#define HCI_ULP_SET_EA_RANDOM_ADDR_ARG_LEN                        ((uint8_t)  4)
#define HCI_ULP_SET_EA_PARAMS_ARG_LEN                             ((uint8_t)  5)
#define HCI_ULP_SET_EA_DATA_ARG_LEN                               ((uint8_t)  4)
#define HCI_ULP_SET_EA_SCAN_RESP_DATA_ARG_LEN                     ((uint8_t)  4)
#define HCI_ULP_EA_ENABLE_ARG_LEN                                 ((uint8_t)  4)
#define HCI_ULP_EA_READ_MAX_ADV_DATA_LEN_ARG_LEN                  ((uint8_t)  7)
#define HCI_ULP_EA_READ_NUM_OF_ADV_SETS_ARG_LEN                   ((uint8_t)  6)
#define HCI_ULP_EA_REMOVE_ADV_SET_ARG_LEN                         ((uint8_t)  4)
#define HCI_ULP_EA_CLEAR_ADV_SETS_ARG_LEN                         ((uint8_t)  4)
#define HCI_ULP_SET_PA_PARAMS_ARG_LEN                             ((uint8_t)  4)
#define HCI_ULP_SET_PA_DATA_ARG_LEN                               ((uint8_t)  4)
#define HCI_ULP_PA_ENABLE_ARG_LEN                                 ((uint8_t)  4)
#define HCI_ULP_SET_ES_PARAMS_ARG_LEN                             ((uint8_t)  4)
#define HCI_ULP_ES_ENABLE_ARG_LEN                                 ((uint8_t)  4)
#define HCI_ULP_PS_CREATE_PA_SYNC_CANCEL_ARG_LEN                  ((uint8_t)  4)
#define HCI_ULP_PS_TERMINATE_PA_SYNC_ARG_LEN                      ((uint8_t)  4)
#define HCI_ULP_PS_ADD_DEVICE_TO_PA_LIST_ARG_LEN                  ((uint8_t)  4)
#define HCI_ULP_PS_REMOVE_DEVICE_FROM_PA_LIST_ARG_LEN             ((uint8_t)  4)
#define HCI_ULP_PS_CLEAR_PA_LIST_ARG_LEN                          ((uint8_t)  4)
#define HCI_ULP_PS_READ_PA_LIST_SIZE_ARG_LEN                      ((uint8_t)  5)
#define HCI_ULP_SET_PA_RECEIVE_ENABLE_ARG_LEN                     ((uint8_t)  4)
#define HCI_ULP_PA_SYNC_TRANSFER_ARG_LEN                          ((uint8_t)  4)
#define HCI_ULP_PA_SET_INFO_TRANSFER_ARG_LEN                      ((uint8_t)  4)
#define HCI_ULP_SET_PA_SYNC_TRANSFER_PARAMS_ARG_LEN               ((uint8_t)  4)
#define HCI_ULP_SET_DEFAULT_PA_SYNC_TRANSFER_PARAMS_ARG_LEN       ((uint8_t)  4)
...
#define HCI_ERROR_MAC_CONNECTION_FAILED                ((hci_error_t)0x3F)
#define HCI_ERROR_COARSE_CLOCK_ADJUST_REJECTED         ((hci_error_t)0x40)
#define HCI_ERROR_TYPE0_SUBMAP_NOT_DEFINED             ((hci_error_t)0x41)
#define HCI_ERROR_UNKNOWN_ADVERTISER_IDENTIFIER        ((hci_error_t)0x42)
#define HCI_ERROR_LIMIT_REACHED                        ((hci_error_t)0x43)
#define HCI_ERROR_OPERATION_CANCELLED_BY_HOST          ((hci_error_t)0x44)
...
#define ULP_FEATURE_STABLE_MODULATION_INDEX_TX              9
#define ULP_FEATURE_STABLE_MODULATION_INDEX_RX              10
#define ULP_FEATURE_BLR_PHY                                 11
...
/*-----------------------------------------------------------------------------*
 *  ULP
 *  2LE, (B)LR and "LE coded" PHYs and related matters
 ...
 *------------------------------------------------------------------------------*/
#define HCI_ULP_PHY_NO_CHANGE                     ((uint8_t)0x00)
...
#define HCI_ULP_PHY_1LE_2LE     (HCI_ULP_2LE_PHY_1MBPS | HCI_ULP_2LE_PHY_2MBPS)                       
#define HCI_ULP_PHY_ALL         (HCI_ULP_PHY_1LE_2LE | HCI_ULP_PHY_LE_CODED)
#define HCI_ULP_PHY_MAX                           ((uint8_t)0xFF)
#define HCI_ULP_PHY_OPT_MAX                       ((uint8_t)0xFFFF)
...
#define HCI_SUPPORTED_CODECS_PER_PTR            (HCI_VAR_ARG_POOL_SIZE / HCI_SUPPORTED_CODEC_OCTETS_SIZE) /* The firmware puts only one uint8_t in each XAP word*/
...
#define HCI_ULP_EV_ADV_DATA_LENGTH                  229
#define HCI_ULP_EV_ADV_DATA_BYTES_PER_PTR           HCI_VAR_ARG_POOL_SIZE
#define HCI_ULP_EV_ADV_DATA_PTRS                    ((HCI_ULP_EV_ADV_DATA_LENGTH + HCI_ULP_EV_ADV_DATA_BYTES_PER_PTR - 1) / HCI_ULP_EV_ADV_DATA_BYTES_PER_PTR)

#define HCI_ULP_EV_PERIODIC_DATA_LENGTH             248
#define HCI_ULP_EV_PERIODIC_DATA_BYTES_PER_PTR      HCI_VAR_ARG_POOL_SIZE
#define HCI_ULP_EV_PERIODIC_DATA_PTRS               ((HCI_ULP_EV_PERIODIC_DATA_LENGTH + HCI_ULP_EV_PERIODIC_DATA_BYTES_PER_PTR - 1) / HCI_ULP_EV_PERIODIC_DATA_BYTES_PER_PTR)

#define HCI_ULP_ADV_DATA_LENGTH                     251
#define HCI_ULP_ADV_DATA_BYTES_PER_PTR              HCI_VAR_ARG_POOL_SIZE
#define HCI_ULP_ADV_DATA_BYTE_PTRS                  ((HCI_ULP_ADV_DATA_LENGTH + HCI_ULP_ADV_DATA_BYTES_PER_PTR -1) / HCI_ULP_ADV_DATA_BYTES_PER_PTR)

#define HCI_ULP_SCAN_RESP_DATA_LENGTH               251
#define HCI_ULP_SCAN_RESP_DATA_BYTES_PER_PTR        HCI_VAR_ARG_POOL_SIZE
#define HCI_ULP_SCAN_RESP_DATA_BYTE_PTRS            ((HCI_ULP_SCAN_RESP_DATA_LENGTH + HCI_ULP_SCAN_RESP_DATA_BYTES_PER_PTR -1) / HCI_ULP_SCAN_RESP_DATA_BYTES_PER_PTR)

#define HCI_ULP_PERIODIC_ADV_DATA_LENGTH            252
#define HCI_ULP_PERIODIC_ADV_DATA_BYTES_PER_PTR     HCI_VAR_ARG_POOL_SIZE
#define HCI_ULP_PERIODIC_ADV_DATA_BYTE_PTRS         ((HCI_ULP_PERIODIC_ADV_DATA_LENGTH + HCI_ULP_PERIODIC_ADV_DATA_BYTES_PER_PTR -1) / HCI_ULP_PERIODIC_ADV_DATA_BYTES_PER_PTR)

#define HCI_ULP_MAX_ENABLE_ADV_SETS                 0x3F
#define HCI_ULP_ENABLE_ADV_SETS_PER_PTR             (HCI_VAR_ARG_POOL_SIZE / HCI_ARC_CONVERT(EA_ENABLE_ADV_SET_T))
#define HCI_ULP_ENABLE_ADV_SETS_PTRS                ((HCI_ULP_MAX_ENABLE_ADV_SETS / HCI_ULP_ENABLE_ADV_SETS_PER_PTR) + 1)

#define HCI_ULP_MAX_INITIATING_PHYS                 2
#define HCI_ULP_INITIATING_PHYS_PER_PTR             (HCI_VAR_ARG_POOL_SIZE / HCI_ARC_CONVERT(ES_INITIATING_PHY_T))
#define HCI_ULP_INITIATING_PHYS_PTRS                ((HCI_ULP_MAX_INITIATING_PHYS / HCI_ULP_INITIATING_PHYS_PER_PTR) + 1)

#define HCI_ULP_MAX_SCANNING_PHYS                   2
#define HCI_ULP_SCANNING_PHYS_PER_PTR               (HCI_VAR_ARG_POOL_SIZE / HCI_ARC_CONVERT(ES_SCANNING_PHY_T))
#define HCI_ULP_SCANNING_PHYS_PTRS                  ((HCI_ULP_MAX_SCANNING_PHYS / HCI_ULP_SCANNING_PHYS_PER_PTR) + 1)
...
/****************************************************************************
    This is done here because the vendor_specific_hci.h file uses
HCI_MANUFACTURER_EXTENSION and HCI_COMMAND_COMMON_T. It has to be included
before the definition of HCI_COMMAND_COMPLETE_ARGS_T and HCI_UPRIM_T because
the unions need HCI_LT_PHY_TEST_MODE_RET_T and HCI_LT_PHY_TEST_MODE_T.
*****************************************************************************/
#include "vendor_specific_hci.h"

#ifdef HOSTTOOLS_BUILD
#include "hci_withdrawn.h"
#endif
...
typedef struct
{
    ...
    uint16_t            duration;         /* How long to advertise for */
    uint8_t             max_ea_events;    /* Max number of EA events */
} EA_ENABLE_ADV_SET_T;
...
/*----------------------------------------------------------------------------*
* PURPOSE
* Used to read the simple pairing options and the maximum encryption key size
* supported. 
*
*----------------------------------------------------------------------------*/
typedef struct
{
    HCI_COMMAND_COMMON_T     common;
} HCI_READ_LOCAL_SIMPLE_PAIRING_OPTIONS_T;
...
/******************************************************************************
 *
 *      Extended Advertising (EA) Command Structures
 *
 *****************************************************************************/

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Advertising Set Random Address Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
...
} HCI_ULP_SET_EA_RANDOM_ADDR_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Extended Advertising Parameters Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    uint24_t                  primary_adv_interval_min;
    uint24_t                  primary_adv_interval_max;
...
} HCI_ULP_SET_EA_PARAMS_T;

typedef struct
{
    uint8_t                   selected_tx_power;
} HCI_ULP_SET_EA_PARAMS_RET_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Extended Advertising Data Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    /*
    * The pointers below, point to a byte array of size HCI_ULP_ADV_DATA_BYTES_PER_PTR.
    */
    uint8_t                  *adv_data[HCI_ULP_ADV_DATA_BYTE_PTRS];
} HCI_ULP_SET_EA_DATA_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Extended Scan Response Data Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    /*
    * The pointers below, point to a byte array of size HCI_ULP_SCAN_RESP_DATA_BYTES_PER_PTR.
    */
    uint8_t                  *scan_resp_data[HCI_ULP_SCAN_RESP_DATA_BYTE_PTRS];
} HCI_ULP_SET_EA_SCAN_RESP_DATA_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Extended Advertising Enable Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    uint8_t                   enable;
    uint8_t                   num_of_sets;
    EA_ENABLE_ADV_SET_T      *adv_sets[HCI_ULP_ENABLE_ADV_SETS_PTRS]; 
} HCI_ULP_EA_ENABLE_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Read Maximum Advertising Data Length Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    HCI_COMMAND_COMMON_T      common;
} HCI_ULP_EA_READ_MAX_ADV_DATA_LEN_T;

typedef struct
{
    uint16_t                  max_adv_data_len;
} HCI_ULP_EA_READ_MAX_ADV_DATA_LEN_RET_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Read Number of Supported Advertising Sets Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    HCI_COMMAND_COMMON_T      common;
} HCI_ULP_EA_READ_NUM_OF_ADV_SETS_T;

typedef struct
{
    uint8_t                   num_of_adv_sets;
} HCI_ULP_EA_READ_NUM_OF_ADV_SETS_RET_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Remove Advertising Set Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    HCI_COMMAND_COMMON_T      common;
    uint8_t                   adv_handle;
} HCI_ULP_EA_REMOVE_ADV_SET_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Clear Advertising Sets Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    HCI_COMMAND_COMMON_T      common;
} HCI_ULP_EA_CLEAR_ADV_SETS_T;

/******************************************************************************
 *
 *      Periodic Advertising (PA) Command Structures
 *
 *****************************************************************************/

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Periodic Advertising Parameters Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
...
} HCI_ULP_SET_PA_PARAMS_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Periodic Advertising Data Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    uint8_t                   adv_data_len;
    /*
    * The pointers below, point to a byte array of size HCI_ULP_PERIODIC_ADV_DATA_BYTES_PER_PTR.
    */
    uint8_t                  *adv_data[HCI_ULP_PERIODIC_ADV_DATA_BYTE_PTRS];
} HCI_ULP_SET_PA_DATA_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Periodic Advertising Enable Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
...
/******************************************************************************
 *
 *      Extended Scanning (ES) Command Structures
 *
 *****************************************************************************/

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Extended Scan Parameters Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    ES_SCANNING_PHY_T        *scanning_phy[HCI_ULP_SCANNING_PHYS_PTRS];
} HCI_ULP_SET_ES_PARAMS_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Extended Scan Enable Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
...
/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Extended Create Connection Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    ES_INITIATING_PHY_T      *init_phy[HCI_ULP_INITIATING_PHYS_PTRS];
} HCI_ULP_ES_CREATE_CONNECTION_T;

/******************************************************************************
 *
 *      Periodic Scanning (PS) Command Structures
 *
 *****************************************************************************/

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Periodic Advertising Create Sync Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
...
/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Periodic Advertising Create Sync Cancel Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    HCI_COMMAND_COMMON_T      common;
} HCI_ULP_PS_CREATE_PA_SYNC_CANCEL_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Periodic Advertising Terminate Sync Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
...
} HCI_ULP_PS_TERMINATE_PA_SYNC_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Add Device To Periodic Advertiser List Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    BD_ADDR_T                 adv_addr;
    uint8_t                   adv_sid;
} HCI_ULP_PS_ADD_DEVICE_TO_PA_LIST_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Remove Device From Periodic Advertiser List Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    BD_ADDR_T                 adv_addr;
    uint8_t                   adv_sid;
} HCI_ULP_PS_REMOVE_DEVICE_FROM_PA_LIST_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Clear Periodic Advertiser List Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    HCI_COMMAND_COMMON_T      common;
} HCI_ULP_PS_CLEAR_PA_LIST_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Read Periodic Advertiser List Size Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    HCI_COMMAND_COMMON_T      common;
} HCI_ULP_PS_READ_PA_LIST_SIZE_T;

typedef struct
{
    uint8_t                   pa_list_size;
} HCI_ULP_PS_READ_PA_LIST_SIZE_RET_T;

/******************************************************************************
 *
 *      Periodic Advertising Sync Transfer (PAST) Command Structures
 *
 *****************************************************************************/
 
 /*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Periodic Advertising Receive Enable Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    uint16_t                  sync_handle;
    uint8_t                   enable;
} HCI_ULP_SET_PA_RECEIVE_ENABLE_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Periodic Advertising Sync Transfer Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
...
/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Periodic Advertising Set Info Transfer Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
...
/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Periodic Advertising Sync Transfer Parameters Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    uint16_t                  sync_timeout;
    uint8_t                   cte_type;
} HCI_ULP_SET_PA_SYNC_TRANSFER_PARAMS_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Default Periodic Advertising Sync Transfer Parameters Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    uint16_t                  sync_timeout;
    uint8_t                   cte_type;
} HCI_ULP_SET_DEFAULT_PA_SYNC_TRANSFER_PARAMS_T;

/***** Periodic Advertising Sync Transfer Commands End *****/
 ...
 * PURPOSE
 *
 *      HCI ULP Extended Advertising Report Event. (0x3E, subevent code: 0x0D)
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    uint8_t                   data_length;
    uint8_t                  *data[HCI_ULP_EV_ADV_DATA_PTRS];
}HCI_EV_ULP_EXT_ADV_REPORT_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *
 *      HCI ULP Periodic Advertising Sync Establishment Event. (0x3E, subevent code: 0x0E)
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
...
}HCI_EV_ULP_PERIODIC_ADV_SYNC_EST_T;
...
}HCI_EV_ULP_PERIODIC_ADV_REPORT_T;
...
typedef struct
{
    HCI_ULP_EVENT_COMMON_T    event;
    uint16_t                  sync_handle;
}HCI_EV_ULP_PERIODIC_ADV_SYNC_LOST_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *
 *      HCI ULP Scan Timeout Event. (0x3E, subevent code: 0x11)
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    HCI_ULP_EVENT_COMMON_T    event;
}HCI_EV_ULP_SCAN_TIMEOUT_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *
 *      HCI ULP Advertising Set Terminated Event. (0x3E, subevent code: 0x12)
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    uint8_t                   adv_handle;
    hci_connection_handle_t   connection_handle;
    uint8_t                   num_completed_ea_events;
}HCI_EV_ULP_ADV_SET_TERMINATED_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *
 *      HCI ULP Scan Request Received Event. (0x3E, subevent code: 0x13)
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
...
}HCI_EV_ULP_SCAN_REQ_RECEIVED_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *
 *      HCI ULP Periodic Advertising Sync Transfer Received Event.
 *      (0x3E, subevent code: 0x18)
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    uint16_t                  periodic_adv_interval;
    uint8_t                   adv_clock_accuracy;
}HCI_EV_ULP_PA_SYNC_TRANSFER_RECEIVED_T;
...
typedef union
{
    ...
    HCI_READ_LOCAL_SIMPLE_PAIRING_OPTIONS_RET_T read_local_simple_pairing_options_args;
    ...
    HCI_ULP_SET_EA_PARAMS_RET_T                             ulp_set_ea_params_args;
    HCI_ULP_EA_READ_MAX_ADV_DATA_LEN_RET_T                  ulp_ea_read_max_adv_data_len_args;
    HCI_ULP_EA_READ_NUM_OF_ADV_SETS_RET_T                   ulp_ea_read_num_of_adv_sets_args;
    HCI_ULP_PS_READ_PA_LIST_SIZE_RET_T                      ulp_ps_read_pa_list_size_args;

#ifdef INSTALL_QUALCOMM_VENDOR_SPECIFIC_HCI
    HCI_ULP_QVS_BT_LOWER_TESTER_RET_T                       ulp_qvs_bt_lower_tester_args;
#endif
...
typedef union hci_uprim_tag
{
    ...
    HCI_READ_LOCAL_SIMPLE_PAIRING_OPTIONS_T hci_read_local_simple_pairing_options;
    ...
    /* Spec BT5.0 has renamed this command to LE_READ_REMOTE_FEATURES and we have updated Btcli printouts.
    We are not going to update the struct name and everything else that is not visible to the Btcli user.*/
    ...
    HCI_ULP_SET_DEFAULT_PHY_T                           hci_ulp_set_default_phy;
    HCI_ULP_SET_PHY_T                                   hci_ulp_set_phy;
    HCI_ULP_SET_EA_RANDOM_ADDR_T                        hci_ulp_set_ea_random_addr;
    HCI_ULP_SET_EA_PARAMS_T                             hci_ulp_set_ea_params;
    HCI_ULP_SET_EA_DATA_T                               hci_ulp_set_ea_data;
    HCI_ULP_SET_EA_SCAN_RESP_DATA_T                     hci_ulp_set_ea_scan_resp_data;
    HCI_ULP_EA_ENABLE_T                                 hci_ulp_ea_enable;
    HCI_ULP_EA_READ_MAX_ADV_DATA_LEN_T                  hci_ulp_ea_read_max_adv_data_len;
    HCI_ULP_EA_READ_NUM_OF_ADV_SETS_T                   hci_ulp_ea_read_num_of_adv_sets;
    HCI_ULP_EA_REMOVE_ADV_SET_T                         hci_ulp_ea_remove_adv_set;
    HCI_ULP_EA_CLEAR_ADV_SETS_T                         hci_ulp_ea_clear_adv_sets;
    HCI_ULP_SET_PA_PARAMS_T                             hci_ulp_set_pa_params;
    HCI_ULP_SET_PA_DATA_T                               hci_ulp_set_pa_data;
    HCI_ULP_PA_ENABLE_T                                 hci_ulp_pa_enable;
    HCI_ULP_SET_ES_PARAMS_T                             hci_ulp_set_es_params;
    HCI_ULP_ES_ENABLE_T                                 hci_ulp_es_enable;
    HCI_ULP_ES_CREATE_CONNECTION_T                      hci_ulp_es_create_connection;
    HCI_ULP_PS_CREATE_PA_SYNC_T                         hci_ulp_ps_create_pa_sync;
    HCI_ULP_PS_CREATE_PA_SYNC_CANCEL_T                  hci_ulp_ps_create_pa_sync_cancel;
    HCI_ULP_PS_TERMINATE_PA_SYNC_T                      hci_ulp_ps_terminate_pa_sync;
    HCI_ULP_PS_ADD_DEVICE_TO_PA_LIST_T                  hci_ulp_ps_add_device_to_pa_list;
    HCI_ULP_PS_REMOVE_DEVICE_FROM_PA_LIST_T             hci_ulp_ps_remove_device_from_pa_list;
    HCI_ULP_PS_CLEAR_PA_LIST_T                          hci_ulp_ps_clear_pa_list;
    HCI_ULP_PS_READ_PA_LIST_SIZE_T                      hci_ulp_ps_read_pa_list_size;
    HCI_ULP_SET_PA_RECEIVE_ENABLE_T                     hci_ulp_set_pa_receive_enable;
    HCI_ULP_PA_SYNC_TRANSFER_T                          hci_ulp_pa_sync_transfer;
    HCI_ULP_PA_SET_INFO_TRANSFER_T                      hci_ulp_pa_set_info_transfer;
    HCI_ULP_SET_PA_SYNC_TRANSFER_PARAMS_T               hci_ulp_set_pa_sync_transfer_params;
    HCI_ULP_SET_DEFAULT_PA_SYNC_TRANSFER_PARAMS_T       hci_ulp_set_default_pa_sync_transfer_params;
...
#ifdef INSTALL_QUALCOMM_VENDOR_SPECIFIC_HCI
    HCI_ULP_QVS_BT_LOWER_TESTER_T                       hci_ulp_qvs_bt_lower_tester;
#endif
    ...
    HCI_EV_ULP_EXT_ADV_REPORT_T                      hci_ulp_ext_adv_report;
    HCI_EV_ULP_PERIODIC_ADV_SYNC_EST_T               hci_ulp_periodic_adv_sync_est;
    HCI_EV_ULP_PERIODIC_ADV_REPORT_T                 hci_ulp_periodic_adv_report;
    HCI_EV_ULP_PERIODIC_ADV_SYNC_LOST_T              hci_ulp_periodic_adv_sync_lost;
    HCI_EV_ULP_SCAN_TIMEOUT_T                        hci_ulp_scan_timeout;
    HCI_EV_ULP_ADV_SET_TERMINATED_T                  hci_ulp_adv_set_terminated;
    HCI_EV_ULP_SCAN_REQ_RECEIVED_T                   hci_ulp_scan_req_received;
    HCI_EV_ULP_PA_SYNC_TRANSFER_RECEIVED_T           hci_ulp_pa_sync_transfer_received;

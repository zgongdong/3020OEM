...
{
    IPC_TRANSFORM_CONVERT_CLOCK ipc_send_prim;
    IPC_TRANSFORM_RSP ipc_recv_prim;
    ipc_send_prim.source = SOURCE_TO_ID(source);
    ipc_send_prim.sink = SINK_TO_ID(sink);
    ipc_send(IPC_SIGNAL_ID_TRANSFORM_CONVERT_CLOCK, &ipc_send_prim, sizeof(ipc_send_prim));
    assert(!ipc_disallow_high_priority_handler_calls());
    (void)ipc_recv(IPC_SIGNAL_ID_TRANSFORM_CONVERT_CLOCK_RSP, &ipc_recv_prim);
    return TRANSFORM_FROM_ID(ipc_recv_prim.ret);
}
...
{
    IPC_TRANSFORM_HASH ipc_send_prim;
    IPC_TRANSFORM_RSP ipc_recv_prim;
    ipc_send_prim.source = SOURCE_TO_ID(source);
    ipc_send_prim.sink = SINK_TO_ID(sink);
    ipc_send(IPC_SIGNAL_ID_TRANSFORM_HASH, &ipc_send_prim, sizeof(ipc_send_prim));
    assert(!ipc_disallow_high_priority_handler_calls());
    (void)ipc_recv(IPC_SIGNAL_ID_TRANSFORM_HASH_RSP, &ipc_recv_prim);
    return TRANSFORM_FROM_ID(ipc_recv_prim.ret);
}
...
{
    IPC_PS_NEXT_KEY ipc_send_prim;
    IPC_BOOL_RSP ipc_recv_prim;
    ipc_send_prim.value = value;
    ipc_send_prim.key = key;
    ipc_send(IPC_SIGNAL_ID_PS_NEXT_KEY, &ipc_send_prim, sizeof(ipc_send_prim));
    assert(!ipc_disallow_high_priority_handler_calls());
    (void)ipc_recv(IPC_SIGNAL_ID_PS_NEXT_KEY_RSP, &ipc_recv_prim);
    return ipc_recv_prim.ret;
}
...
{
    IPC_PS_NEXT_AUDIO_KEY ipc_send_prim;
    IPC_BOOL_RSP ipc_recv_prim;
    ipc_send_prim.value = value;
    ipc_send_prim.key = key;
    ipc_send(IPC_SIGNAL_ID_PS_NEXT_AUDIO_KEY, &ipc_send_prim, sizeof(ipc_send_prim));
    assert(!ipc_disallow_high_priority_handler_calls());
    (void)ipc_recv(IPC_SIGNAL_ID_PS_NEXT_AUDIO_KEY_RSP, &ipc_recv_prim);
    return ipc_recv_prim.ret;
}
...
{
    IPC_PS_DEFRAG_BLOCKING ipc_send_prim;
    IPC_VOID_RSP ipc_recv_prim;
    ipc_send(IPC_SIGNAL_ID_PS_DEFRAG_BLOCKING, &ipc_send_prim, sizeof(ipc_send_prim));
    assert(!ipc_disallow_high_priority_handler_calls());
    (void)ipc_recv(IPC_SIGNAL_ID_PS_DEFRAG_BLOCKING_RSP, &ipc_recv_prim);
}
...
{
    IPC_RA_PARTITION_OPEN ipc_send_prim;
    IPC_RAPARTITION_RESULT_RSP ipc_recv_prim;
    ipc_send_prim.handle = handle;
    ipc_send_prim.partition_info = partition_info;
    ipc_send(IPC_SIGNAL_ID_RA_PARTITION_OPEN, &ipc_send_prim, sizeof(ipc_send_prim));
    assert(!ipc_disallow_high_priority_handler_calls());
    (void)ipc_recv(IPC_SIGNAL_ID_RA_PARTITION_OPEN_RSP, &ipc_recv_prim);
    return ipc_recv_prim.ret;
}
...
{
    IPC_RA_PARTITION_CLOSE ipc_send_prim;
    IPC_RAPARTITION_RESULT_RSP ipc_recv_prim;
    ipc_send_prim.handle = handle;
    ipc_send(IPC_SIGNAL_ID_RA_PARTITION_CLOSE, &ipc_send_prim, sizeof(ipc_send_prim));
    assert(!ipc_disallow_high_priority_handler_calls());
    (void)ipc_recv(IPC_SIGNAL_ID_RA_PARTITION_CLOSE_RSP, &ipc_recv_prim);
    return ipc_recv_prim.ret;
}
...
{
    IPC_RA_PARTITION_ERASE ipc_send_prim;
    IPC_RAPARTITION_RESULT_RSP ipc_recv_prim;
    ipc_send_prim.handle = handle;
    ipc_send_prim.offset = offset;
    ipc_send(IPC_SIGNAL_ID_RA_PARTITION_ERASE, &ipc_send_prim, sizeof(ipc_send_prim));
    assert(!ipc_disallow_high_priority_handler_calls());
    (void)ipc_recv(IPC_SIGNAL_ID_RA_PARTITION_ERASE_RSP, &ipc_recv_prim);
    return ipc_recv_prim.ret;
}
...
{
    IPC_RA_PARTITION_WRITE ipc_send_prim;
    IPC_RAPARTITION_RESULT_RSP ipc_recv_prim;
    ipc_send_prim.handle = handle;
    ipc_send_prim.offset = offset;
    ipc_send_prim.length = length;
    ipc_send_prim.buffer = buffer;
    ipc_send(IPC_SIGNAL_ID_RA_PARTITION_WRITE, &ipc_send_prim, sizeof(ipc_send_prim));
    assert(!ipc_disallow_high_priority_handler_calls());
    (void)ipc_recv(IPC_SIGNAL_ID_RA_PARTITION_WRITE_RSP, &ipc_recv_prim);
    return ipc_recv_prim.ret;
}
...
{
    IPC_RA_PARTITION_READ ipc_send_prim;
    IPC_RAPARTITION_RESULT_RSP ipc_recv_prim;
    ipc_send_prim.handle = handle;
    ipc_send_prim.offset = offset;
    ipc_send_prim.length = length;
    ipc_send_prim.buffer = buffer;
    ipc_send(IPC_SIGNAL_ID_RA_PARTITION_READ, &ipc_send_prim, sizeof(ipc_send_prim));
    assert(!ipc_disallow_high_priority_handler_calls());
    (void)ipc_recv(IPC_SIGNAL_ID_RA_PARTITION_READ_RSP, &ipc_recv_prim);
    return ipc_recv_prim.ret;
}
...
{
    IPC_RA_PARTITION_BG_ERASE ipc_send_prim;
    ipc_send_prim.handle = handle;
    ipc_send_prim.offset = offset;
    ipc_send(IPC_SIGNAL_ID_RA_PARTITION_BG_ERASE, &ipc_send_prim, sizeof(ipc_send_prim));
}

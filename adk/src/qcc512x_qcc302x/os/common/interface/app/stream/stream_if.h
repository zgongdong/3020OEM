...
typedef enum
{
    ...
    STREAM_AUDIO_SYNC_SOURCE_MTU = 0x1401,                 /*!< Maximum payload size in bytes for audio synchronisation
                                                                source stream.*/
    STREAM_AUDIO_SYNC_LATENCY = 0x1402,                    /*!< Audio latency in microseconds to be used for audio synchronisation
                                                                source/sink stream.*/
    STREAM_AUDIO_SYNC_SINK_MODE = 0x1403                   /*!< Mode of operation for audio synchronisation sink stream.
                                                                See #audio_sync_sink_mode documentation for details*/
} stream_config_key;
...
/*!
  @brief Operation mode for audio sync sink stream. To be used with STREAM_AUDIO_SYNC_SINK_MODE key.
*/
typedef enum
{

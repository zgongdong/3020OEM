...
const rule_entry_t primary_rules_set[] =
{
    ...
    /*! \{
        Rules to abort DFU when primary earbud is taken out of case during DFU. */
    RULE(RULE_EVENT_OUT_CASE,                   ruleNotifyDFUAbort,                 CONN_RULES_DFU_ABORT),
    RULE(RULE_EVENT_IN_EAR,                     ruleNotifyDFUAbort,                 CONN_RULES_DFU_ABORT),
    /*! \} */
